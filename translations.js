...
const translations = {
  es: {
    ...
    'project.bid.title': 'BID - Secretaría',
    'project.bid.desc': 'Rediseño estratégico de servicios internos en la Secretaría del BID. 80 entrevistas en 7-10 países, diagnóstico de 50+ sistemas y rediseño de procesos invisibles para mejorar la coordinación y reducir la sobrecarga operativa.',
    'project.bid.metric1': 'Entrevistas',
    'project.bid.metric2': 'Sistemas analizados',
    'project.bid.metric3': 'Duración',
    ...
    // PROYECTO: CLÍNICA ALEMANA - AGENDA WEB

    'project.agenda.hero-title': 'Clínica Alemana de Santiago – Agenda Web',
    'project.agenda.hero-subtitle': 'Rediseño de la agenda web durante la pandemia, permitiendo agendamiento médico completamente digital y coordinado con teleconsulta. Un proyecto que transformó la atención de más de 70,000 pacientes.',

    'project.agenda.context-text-1': 'Durante la pandemia de 2020, Clínica Alemana necesitaba transformar urgentemente sus canales de atención para permitir agendamiento de consultas médicas completamente en línea. Esta solución debía desarrollarse en paralelo con una nueva plataforma de teleconsulta, asegurando una experiencia integrada, fluida y segura para pacientes y equipos internos.',
    'project.agenda.context-text-2': 'El reto no era solo tecnológico: muchas personas aún no estaban familiarizadas con entornos digitales, y el sistema heredado dificultaba tanto la navegación del paciente como la gestión del personal clínico. Además, trabajamos en un ecosistema complejo con múltiples equipos y consultoras desarrollando soluciones complementarias.',
    ...
    'project.agenda.challenge-text': '¿Cómo diseñar un nuevo canal digital de agendamiento médico que conectara de forma coherente con el servicio de teleconsulta, mejorando la experiencia del paciente en un contexto de alta urgencia sanitaria, coordinando múltiples equipos y plataformas en paralelo?',

    'project.agenda.role-text': 'Como UX/Service Designer en Continuum, trabajé durante 14 meses en este proyecto, liderando el diseño estratégico del servicio, facilitando talleres, guiando la visión de experiencia y alineando flujos entre los distintos sistemas, equipos y canales.',
    'project.agenda.team-1': 'Yo (UX/Service Designer + Researcher)',
    'project.agenda.team-2': '1 UX/UI Designer',
    ...
    'project.agenda.process-intro': 'Implementamos un proceso iterativo de diseño centrado en el usuario, adaptándonos constantemente a las necesidades emergentes durante la pandemia y coordinando múltiples frentes de trabajo simultáneos.',
    ...
    'project.agenda.process-1-item-3': 'Identificación de puntos críticos: lentitud, duplicidad de pasos, lenguaje poco claro, dificultad para autogestionar cambios',
    ...
    'project.agenda.result-3-value': 'Médicos incorporados',
    'project.agenda.result-4-value': 'Participación en peak pandemia',
    ...
    'project.agenda.learning-1-text': 'Trabajar simultáneamente con Continuum, Globant, 2Brains y el equipo interno de Clínica Alemana me enseñó la importancia de mantener canales de comunicación claros, documentación compartida y una visión de experiencia unificada incluso cuando los equipos trabajan en componentes distintos.',
    'project.agenda.learning-2-title': 'Diseño resiliente en tiempos de incertidumbre',
    'project.agenda.learning-2-text': 'La pandemia nos obligó a diseñar con flexibilidad extrema: los requisitos cambiaban semanalmente, las prioridades se ajustaban según la emergencia sanitaria, y debíamos equilibrar velocidad con calidad. Aprendí a crear sistemas de diseño adaptables que pudieran evolucionar sin colapsar.',
    'project.agenda.learning-3-title': 'La importancia del diseño incremental',
    'project.agenda.learning-3-text': 'El enfoque de lanzamiento progresivo (friends & family → público general → mejora continua) permitió validar hipótesis en entornos reales antes de escalar, reduciendo riesgos y mejorando la calidad final del servicio.',

    'project.agenda.reflection-quote': 'Diseñar en sincronía con múltiples equipos, sin perder de vista al usuario.',
    'project.agenda.reflection-1': 'Este proyecto me mostró que diseñar una agenda web puede parecer un reto técnico, pero en este caso, fue también un ejercicio profundo de empatía, claridad de procesos y resiliencia en medio del caos. Coordinar con múltiples consultoras y equipos internos, cada uno con sus propias metodologías y prioridades, requirió no solo habilidades de diseño sino también diplomacia, comunicación estratégica y una visión clara del norte común.',
    'project.agenda.reflection-2': 'Acompañar este canal durante 14 meses me permitió ver cómo la experiencia digital puede transformarse desde lo esencial, creciendo con propósito y sentido. Ver cómo más de 70,000 personas pudieron acceder a atención médica de calidad en momentos críticos, muchas de ellas con poca experiencia tecnológica previa, reafirmó mi convicción sobre el poder del diseño centrado en las personas.',
    'project.agenda.reflection-3': 'Este proyecto no solo transformó el servicio de la Clínica Alemana; transformó también mi forma de entender el diseño de servicios en ecosistemas complejos y mi capacidad para mantener el foco humano incluso bajo presión extrema.',

    'project.agenda.visual-findings-desc': 'Presentación de hallazgos en modo storytelling para comunicar insights al equipo y stakeholders.',
    ...
    'project.agenda.visual-blueprint-desc': 'Entender las áreas, el servicio y cómo este debía integrarse a los sistemas existentes de la clínica.',
    ...
    'project.teleconsulta.hero-subtitle': 'Diseño desde cero de una plataforma de videollamadas médicas integrada con el sistema de agenda web. Automatización de cobros, entrega de recetas y gestión de documentos clínicos con 40% de reducción en quejas.',

    'project.teleconsulta.context-text-1': 'Durante el 2020, en plena pandemia, acompañamos a la Clínica Alemana de Santiago en el diseño de su propia plataforma de teleconsulta. Aunque el desarrollo se realizó en paralelo al rediseño de su Agenda Web, ambos equipos trabajamos de forma coordinada para asegurar una experiencia fluida y continua para pacientes y médicos.',
    'project.teleconsulta.context-text-2': 'Esta nueva solución debía responder a desafíos específicos del contexto sanitario, facilitar la experiencia digital de públicos aún no acostumbrados a este tipo de plataformas y, al mismo tiempo, liberar la carga operativa que enfrentaba el equipo médico.',
    'project.teleconsulta.context-text-3': 'El proyecto se desarrolló en un ecosistema complejo, coordinando con múltiples equipos y consultoras:',

    'project.teleconsulta.challenge-text': '¿Cómo diseñar una plataforma de teleconsulta médica desde cero, en plena emergencia sanitaria, que permitiera atención remota segura y eficiente, sin aumentar la carga operativa del personal médico?',

    'project.teleconsulta.role-text': 'Participé como diseñadora de servicios, velando por que la experiencia de atención fuera consistente y clara a lo largo de todos los puntos de contacto. Acompañé el proceso durante 14 meses (el equipo continuó después de mi salida), aplicando un enfoque de diseño incremental que nos permitió lanzar una versión inicial en 6 meses y seguir iterando con mejoras de valor para usuarios y equipos.',
    ...
    'project.teleconsulta.process-intro': 'El proyecto se llevó a cabo en un contexto de alta incertidumbre, con un deadline muy ajustado y grandes desafíos para hacer investigación o testeo en terreno. Aun así, diseñamos un proceso enfocado en comprender profundamente los problemas de pacientes, médicos y equipos administrativos.',
    ...
    'project.teleconsulta.reflection-1': 'Este proyecto fue un desafío tanto técnico como emocional. Trabajamos con urgencia, pero sin perder el foco humano. La decisión de comunicar los hallazgos mediante una narrativa cinematográfica (los "actos" de Mariana y Fernando) no fue solo una elección creativa, sino estratégica: necesitábamos que stakeholders, desarrolladores y equipos médicos entendieran visceralmente los pain points de los usuarios.',
    'project.teleconsulta.reflection-2': 'Ver cómo la historia resonaba en las presentaciones, cómo los equipos comenzaban a referirse a "el Acto 4" o "el problema del Mago de Oz", me enseñó que el diseño de servicios no es solo mapear flujos, sino crear lenguajes compartidos que faciliten la toma de decisiones.',
    'project.teleconsulta.reflection-3': 'La profundidad de la investigación, el cuidado en los detalles y la coordinación entre múltiples equipos hicieron posible algo que parecía inviable en medio de la incertidumbre. Acompañar esta transformación desde el diseño de servicios fue una lección de empatía, estrategia y compromiso con el valor real.',
    'project.teleconsulta.reflection-4': 'Este proyecto reafirmó mi convicción: las mejores soluciones nacen cuando combinamos rigor metodológico con profunda empatía humana, y cuando sabemos comunicar nuestros hallazgos de forma que inspiren acción.',

    'project.teleconsulta.visual-blueprint-desc': 'Mapa completo del servicio mostrando todos los touchpoints, actores y sistemas involucrados en la experiencia de teleconsulta.',
    ...
    'project.teleconsulta.visual-storytelling-desc': 'Storytelling visual con la narrativa de Mariana y Fernando, estructurada como una película con actos que representan los pain points del servicio.',
    ...
    'project.teleconsulta.visual-personas-desc': 'Perfiles de usuario creados a partir de la investigación, con sus pain points principales y contexto de uso.',
    ...
    'project.teleconsulta.visual-prototypes-desc': 'Wireframes y prototipos de las vistas principales tanto para médicos como para pacientes.',
    ...
    'project.cubico.hero-subtitle': 'Programa educativo colaborativo que empoderó a 85 jóvenes en Sevilla para diseñar soluciones sostenibles en su comunidad, formando a 12 docentes en metodologías de diseño centrado en las personas.',

    'project.cubico.context-text-1': 'En colaboración con Fruta, consultora especializada en diseño para la sostenibilidad, y Cubico Iberia, empresa líder en inversiones sostenibles, desarrollamos un programa piloto de responsabilidad social corporativa (RSC) en Morón de la Frontera, Sevilla.',
    'project.cubico.context-text-2': 'El objetivo era fortalecer el vínculo entre educación, sostenibilidad y energía renovable, empoderando a jóvenes para que se conviertan en agentes de cambio en sus comunidades. Este programa buscaba no solo educar sobre sostenibilidad, sino dar a los estudiantes herramientas reales de diseño para identificar y resolver problemas locales.',
    'project.cubico.context-text-3': 'El proyecto se desarrolló en dos colegios de la zona, trabajando tanto con estudiantes de ESO (Educación Secundaria Obligatoria) como de Formación Profesional, cada uno con necesidades y contextos diferentes.',

    'project.cubico.challenge-text': 'Diseñar e implementar un programa educativo que integrara innovación, sostenibilidad y energía, dirigido a estudiantes de secundaria y formación profesional. El reto consistía en crear una metodología participativa que permitiera a los jóvenes identificar y resolver problemas sociales y ambientales locales, fomentando su compromiso con el desarrollo sostenible.',

    'project.cubico.role-text': 'Como Service Designer en Fruta, trabajé durante 5 meses en este proyecto, siendo parte de un equipo multidisciplinario de 4 personas.',

    'project.cubico.resp-1': 'Liderar la conceptualización del programa educativo basado en Design Thinking',
    'project.cubico.resp-2': 'Co-diseñar y facilitar 4 workshops presenciales iniciales con jóvenes de la comunidad para entender problemáticas locales',
    ...
    'project.cubico.process-intro': 'Diseñamos un proceso participativo basado en Design Thinking, adaptado específicamente para el contexto educativo y las necesidades de jóvenes en formación. El programa se estructuró en fases progresivas que permitieron a los estudiantes pasar de la observación a la acción.',
    ...
    'project.cubico.process-3-item-1': 'Diseño de un tablero de juego interactivo que guiaba a los estudiantes a través de las fases del proceso de diseño',
    ...
    'project.cubico.methodology-intro': 'Todo el programa fue una adaptación cuidadosa de la metodología de pensamiento de diseño (Design Thinking) al contexto educativo. No se trató simplemente de "enseñar" Design Thinking, sino de crear una experiencia donde los jóvenes vivieran el proceso completo:',
    'project.cubico.methodology-empathize-title': '🔍 Empatizar',
    'project.cubico.methodology-empathize-text': 'Los workshops iniciales con la comunidad permitieron a los estudiantes comprender problemas reales de su entorno, no problemas abstractos o teóricos.',
    'project.cubico.methodology-define-title': '🎯 Definir',
    'project.cubico.methodology-define-text': 'Con las herramientas pedagógicas, los equipos aprendieron a sintetizar información y enfocar sus esfuerzos en problemas específicos y accionables.',
    'project.cubico.methodology-ideate-title': '💡 Idear',
    'project.cubico.methodology-ideate-text': 'El tablero de juego interactivo facilitaba sesiones de ideación colaborativa, fomentando la creatividad sin perder el foco en la sostenibilidad.',
    'project.cubico.methodology-prototype-title': '🛠️ Prototipar',
    'project.cubico.methodology-prototype-text': 'Los estudiantes desarrollaron prototipos tangibles de sus soluciones, aprendiendo sobre iteración y mejora continua.',
    'project.cubico.methodology-test-title': '🧪 Testear',
    'project.cubico.methodology-test-text': 'Las presentaciones finales funcionaron como momentos de validación, donde recibieron feedback de docentes, pares y representantes de Cubico.',

    'project.cubico.result-1-value': 'Docentes formados en Design Thinking',
    'project.cubico.result-2-value': 'Estudiantes participantes (ESO + FP)',
    ...
    'project.cubico.reflection-1': 'Este proyecto reafirmó mi convicción sobre el poder del diseño estratégico y participativo para generar impacto social. Fue inspirador ver cómo, a través de herramientas adecuadas y un enfoque colaborativo, los jóvenes pueden convertirse en protagonistas del cambio en sus comunidades.',
    'project.cubico.reflection-2': 'Trabajar con docentes fue especialmente enriquecedor: no se trataba solo de entregarles un "kit" pedagógico, sino de co-crear con ellos, respetando su conocimiento del contexto educativo y adaptando nuestras metodologías a sus realidades. Ver cómo abrazaban el Design Thinking y lo hacían suyo fue uno de los mayores logros del proyecto.',
    'project.cubico.reflection-3': 'Además, fortaleció mi habilidad para adaptar metodologías de diseño a contextos educativos y culturales diversos. Aprendí que diseñar para educación no es solo crear contenidos, sino crear experiencias que transformen la forma en que jóvenes y docentes se relacionan con los problemas de su entorno.',
    'project.cubico.reflection-4': 'Ver el proyecto ganador implementarse y generar beneficios reales en Morón de la Frontera fue la confirmación de que cuando empoderamos a las personas con herramientas de diseño, no solo resuelven problemas: crean futuros posibles.',

    'project.cubico.visual-toolkit-title': 'Toolkit para el reto',
    'project.cubico.visual-toolkit-desc': 'Herramientas pedagógicas diseñadas para guiar a los estudiantes a través de las fases del Design Thinking.',
    ...
    'project.cubico.visual-booklet-text': 'Si quieres aprender más sobre lo que hicimos con la comunidad de Morón de la Frontera puedes leer nuestro libreto',
    'project.cubico.visual-booklet-btn': 'Descargar libreto',

    'sidebar.project-reach': 'Alcance del Proyecto',
    'sidebar.workshops-discovery': 'Workshops Discovery',
    'sidebar.workshops-presential': 'presenciales',
    'sidebar.teacher-workshops': 'Talleres Docentes',
    'sidebar.per-school-total': 'por colegio (4 total)',
    'sidebar.digital-sessions': 'Sesiones Digitales',
    'sidebar.with-students': 'con estudiantes',
    'sidebar.teachers-label': 'Docentes',
    'sidebar.trained': 'formados',
    'sidebar.students-label': 'Estudiantes',
    ...
    'project.spotify.hero-subtitle': 'Investigación cualitativa sobre patrones de suscripción a Spotify Premium en Perú. Estudio comparativo bilingüe que refutó la hipótesis inicial del cliente, revelando insights sobre comportamiento de usuarios en mercados emergentes.',
    
    // Context
    'project.spotify.context-text-1': 'Este proyecto surgió de un partnership entre Spotify, una consultora alemana, y Ayer Viernes (Chile), quienes nos invitaron a participar como equipo de investigación para el mercado peruano. Spotify había detectado un patrón inusual: en países como Perú, muchos usuarios se suscribían directamente a Premium sin usar primero el plan gratuito, contrario a lo que ocurría en otros mercados.',
    'project.spotify.context-text-2': 'El equipo global asumía que esto se debía a una percepción de mayor valor en el plan pago, pero no había data cualitativa que lo respaldara. Era necesario investigar si esta hipótesis se sostenía en el contexto local y, de no ser así, entender qué estaba realmente sucediendo.',
    'project.spotify.context-nda': 'Nota: Este proyecto estuvo bajo NDA (Non-Disclosure Agreement), por lo que la información compartida aquí se limita a aspectos metodológicos, aprendizajes generales y mi rol en el proceso, sin revelar datos sensibles o propietarios del cliente.',
    
    // Challenge
    'project.spotify.challenge-text': '¿Por qué los usuarios en Perú se suscriben directamente a Spotify Premium sin hacer uso del espacio freemium que ofrece la plataforma? ¿Realmente valoran más el plan pago, o hay otros factores en juego?',
    
    // Role
    'project.spotify.role-text': 'Participé como UX Researcher en un equipo core de 3 personas, siendo la segunda en el equipo de investigación.',
    ...
    // Process
    'project.spotify.process-intro': 'Diseñamos un proceso de investigación cualitativa riguroso, bilingüe y culturalmente sensible, que nos permitiera validar o refutar la hipótesis inicial del cliente.',
    ...
    'project.spotify.process-1-item-1': 'Hipótesis inicial: "En Perú, los usuarios se suscriben directamente a Spotify Premium porque perciben más valor en el plan pago que en el gratuito"',
    ...
    'project.spotify.findings-intro': 'La investigación reveló hallazgos importantes que cambiaron la comprensión del cliente sobre el mercado peruano:',
    
    'project.spotify.finding-1-title': '🔍 La hipótesis fue refutada',
    'project.spotify.finding-1-text': 'Los usuarios NO valoraban más el plan Premium per se. La realidad era más compleja: muchos ya habían tenido contacto previo con Spotify (a través de cuentas familiares, correos antiguos, o períodos de prueba anteriores), lo que los llevaba a suscribirse directamente sin explorar el freemium nuevamente.',
    
    'project.spotify.finding-2-title': '📱 Contexto cultural y tecnológico',
    'project.spotify.finding-2-text': 'Identificamos barreras específicas del mercado peruano relacionadas con confianza digital, métodos de pago, terminología traducida y patrones de uso de tecnología que diferían significativamente de mercados desarrollados.',
    
    'project.spotify.finding-3-title': '🎵 Competencia y alternativas',
    'project.spotify.finding-3-text': 'Los usuarios peruanos utilizaban múltiples plataformas simultáneamente (YouTube, servicios preinstalados en móviles, etc.), cada una para diferentes necesidades, lo que complejizaba el journey de adopción.',
    
    'project.spotify.finding-4-title': '💡 Oportunidades identificadas',
    'project.spotify.finding-4-text': 'Propusimos mejoras específicas en comunicación, onboarding, localización de contenido y estrategias de conversión adaptadas a las realidades del mercado local.',
    
    // Results
    'project.spotify.result-1-value': 'Personas screened',
    'project.spotify.result-2-value': 'Entrevistas en profundidad',
    ...
    'project.spotify.learning-1-text': 'Este proyecto me enseñó que las hipótesis iniciales del cliente, aunque lógicas, no siempre reflejan la realidad. La investigación cualitativa rigurosa es fundamental para revelar las verdaderas motivaciones y comportamientos de los usuarios, especialmente en mercados con contextos culturales y económicos diferentes.',
    
    'project.spotify.learning-2-title': 'Investigación bilingüe y sensibilidad cultural',
    'project.spotify.learning-2-text': 'Trabajar en español con usuarios peruanos y luego traducir hallazgos al inglés para un equipo global requiere no solo dominio del idioma, sino comprensión profunda de matices culturales que no siempre son evidentes en una traducción literal.',
    
    'project.spotify.learning-3-title': 'Escuchar sin asumir',
    'project.spotify.learning-3-text': 'Los datos cuantitativos mostraban un patrón (suscripción directa a Premium), pero solo la investigación cualitativa reveló el "por qué" real: experiencias previas con la plataforma, no percepción de mayor valor. Este proyecto reforzó mi convicción sobre el poder de las entrevistas en profundidad.',
    
    // Reflections
    'project.spotify.reflection-quote': 'La data sin contexto puede reforzar ideas equivocadas.',
    'project.spotify.reflection-1': 'Este estudio confirmó que escuchar a los usuarios cambia el rumbo de decisiones de negocio. En este caso, permitió evitar invertir recursos en estrategias mal enfocadas y alinearse mejor con las realidades del mercado local.',
    'project.spotify.reflection-2': 'Trabajar con un cliente global como Spotify, bajo NDA, y con la responsabilidad de traducir no solo idiomas sino contextos culturales, fue un reto formativo que fortaleció mis habilidades como researcher. Aprendí que la buena investigación no se trata solo de recolectar datos, sino de interpretarlos con empatía y rigor, comunicarlos con claridad y, sobre todo, tener la valentía de refutar hipótesis cuando la evidencia lo demanda.',
    'project.spotify.reflection-3': 'Este proyecto también me mostró la importancia de trabajar en equipos multiculturales y multilingües, donde cada miembro aporta perspectivas únicas que enriquecen el análisis final.',
    ...
    'sidebar.interested-text-spotify': 'Si quieres conocer más sobre mi trabajo en investigación cualitativa y análisis de usuarios, hablemos.',

  // PROYECTO: MINCETUR - CONSTRUCCIÓN FUTURA

    'project.mincetur.hero-title': 'MINCETUR — Construcción Futura',
    'project.mincetur.hero-subtitle': 'Taller intensivo de 3 días con líderes de CITE de todo Perú para co-crear un modelo de gestión replicable. Herramientas diseñadas seguían en uso 2 años después.',
    
    'project.mincetur.context-text-1': 'Este proyecto fue un taller intensivo de 3 días solicitado por el Ministerio de Comercio Exterior y Turismo (MINCETUR) de Perú, con el objetivo de acompañar a los líderes de los CITE (Centros de Innovación Productiva y Transferencia Tecnológica) en la construcción de un modelo de gestión replicable y alineado con los requerimientos del Estado.',
    'project.mincetur.context-text-2': 'Los CITE son centros estratégicos que impulsan la innovación en sectores como artesanía y turismo, pero enfrentaban desafíos para estructurar sus planes de gestión, optimizar el uso de presupuestos y cumplir con los KPIs exigidos por el gobierno. El taller buscaba traducir el lenguaje técnico estatal en un formato accesible y útil para los líderes de estos centros.',
    'project.mincetur.context-text-3': 'Trabajando desde Creative Lab, creamos herramientas propias, adaptamos otras existentes y facilitamos todo el proceso de principio a fin. A través de dinámicas colaborativas, ayudamos a los participantes a interpretar datos, definir metas y visualizar de forma clara sus hojas de ruta.',
    'project.mincetur.context-note': 'Nota personal: Este fue uno de mis primeros proyectos como Service Designer, y fue una experiencia formativa invaluable sobre facilitación intensiva y diseño de herramientas estratégicas.',
    
    'project.mincetur.challenge-text': 'Diseñar y facilitar un taller intensivo de 3 días que permitiera a líderes de CITE de todo Perú co-crear un modelo de gestión replicable, traduciendo los complejos requerimientos del Estado en herramientas prácticas y accesibles que pudieran implementar inmediatamente.',
    
    'project.mincetur.role-text': 'Participé como Service Designer en Creative Lab, siendo la más junior del equipo de 4 personas. Este fue uno de mis primeros proyectos profesionales, y me permitió aprender sobre facilitación de talleres intensivos y diseño estratégico en contextos gubernamentales.',
    ...
    'project.mincetur.process-intro': 'El proyecto se estructuró en dos fases: una preparación intensiva de 2 semanas y un taller presencial de 3 días con todos los líderes de CITE.',
    ...
    'project.mincetur.finding-1-text': 'Aunque todos son parte del mismo sistema MINCETUR, cada CITE enfrentaba desafíos únicos según su región, recursos y contexto local. La flexibilidad metodológica fue crucial para que las herramientas fueran útiles para todos.',
    
    'project.mincetur.finding-2-title': 'Traducir el lenguaje del Estado es fundamental',
    'project.mincetur.finding-2-text': 'Los requerimientos técnicos del gobierno estaban expresados en un lenguaje burocrático complejo. Traducir esto a formatos entendibles y visuales mejoró dramáticamente la apropiación de los líderes locales.',
    
    'project.mincetur.finding-3-title': 'La co-creación desde el día 1 genera compromiso real',
    'project.mincetur.finding-3-text': 'No impusimos un modelo pre-diseñado: facilitamos que ellos mismos lo construyeran. Esta participación activa (no solo consultiva) generó apropiación genuina del proceso y las herramientas.',
    
    'project.mincetur.finding-4-title': 'La visualización de objetivos fortalece el propósito',
    'project.mincetur.finding-4-text': 'Ver sus metas, KPIs y responsabilidades plasmadas visualmente ayudó a los equipos a entender el panorama completo y sentirse empoderados para ejecutar.',
    
    'project.mincetur.result-1-value': 'Días de taller intensivo',
    'project.mincetur.result-2-value': 'Líderes de CITE participantes',
    ...
    'project.mincetur.learning-1-text': 'Como la más junior del equipo, este taller me enseñó que facilitar no es solo guiar dinámicas, sino sostener espacios seguros donde las personas se sientan capaces de crear. Ver cómo los líderes de CITE se apropiaban de las herramientas fue mi primera gran lección sobre el poder del diseño participativo.',
    
    'project.mincetur.learning-2-title': 'Adaptar es más valioso que imponer',
    'project.mincetur.learning-2-text': 'No existe un "modelo único" que funcione para todos. Aprendí que las mejores herramientas son aquellas que los usuarios entienden, adaptan y hacen suyas. En procesos de facilitación intensiva, adaptar el método al ritmo y lenguaje del usuario es más importante que seguir la estructura perfecta.',
    
    'project.mincetur.learning-3-title': 'El impacto del diseño no se mide solo al final',
    'project.mincetur.learning-3-text': 'Enterarnos 2 años después de que los CITE seguían usando las herramientas que creamos fue la confirmación de que diseñamos algo realmente útil. El verdadero éxito no es solo entregar un workshop, sino crear valor sostenible.',
    
    'project.mincetur.learning-4-title': 'Diseñar para el sector público requiere sensibilidad especial',
    'project.mincetur.learning-4-text': 'Trabajar con entidades gubernamentales implica navegar burocracia, lenguaje técnico y múltiples stakeholders. Este proyecto me enseñó a traducir complejidad en claridad sin perder rigor.',
    
    'project.mincetur.reflection-quote': 'La herramienta más potente es aquella que los usuarios hacen suya.',
    'project.mincetur.reflection-1': 'Este proyecto me enseñó que en procesos de facilitación intensiva, la clave está en acompañar con empatía y claridad. No se trata de llegar con soluciones pre-armadas, sino de crear el espacio y las herramientas para que las personas construyan sus propias respuestas.',
    'project.mincetur.reflection-2': 'Siendo uno de mis primeros proyectos profesionales, me marcó profundamente. Aprendí que el diseño de servicios no es solo metodología, sino también escucha activa, flexibilidad y confianza en la capacidad de las personas para resolver sus propios desafíos cuando se les dan las herramientas adecuadas.',
    'project.mincetur.reflection-3': 'Ver que 2 años después los CITE seguían usando lo que co-creamos juntos fue la mayor validación: diseñamos algo que realmente les sirvió. Y eso, para mí, es el verdadero éxito del diseño estratégico.',
    ...
    'project.tali.hero-title': 'TALI — Agencia de Viajes Corporativa',
    'project.tali.hero-subtitle': 'Proyecto freelance para crear una agencia de viajes completamente digital orientada a corporaciones. Investigación, diseño de experiencia para 4 perfiles de usuario y creación completa de marca desde cero.',
    
    'project.tali.context-text-1': 'Este proyecto nació como una iniciativa privada para crear una agencia de viajes completamente digital orientada a empleados de grandes corporaciones. Se trató de diseñar un servicio que permitiera planificar, visualizar y gestionar viajes corporativos desde diferentes dispositivos y roles, sin fricción.',
    'project.tali.context-text-2': 'Trabajamos como equipo freelance de 3 personas durante 2 meses, desarrollando todo desde cero: investigación de mercado, definición de usuarios, diseño de experiencia, creación de marca, naming y propuesta de valor completa.',
    'project.tali.context-text-3': 'Aunque el proyecto no se implementó por temas de financiamiento, realizamos una entrega completa que incluyó investigación cualitativa, clusterización de insights, diseño de flujos diferenciados por usuario, identidad de marca (incluyendo el nombre TALI) y landing page funcional. Fue una experiencia valiosa por la complejidad de usuarios, casuísticas y flujos involucrados.',
    
    'project.tali.challenge-text': 'Diseñar desde cero una plataforma digital que permitiera a múltiples perfiles de usuario (viajeros, supervisores, RRHH, soporte) gestionar viajes corporativos de forma fluida, considerando las complejidades de autorizaciones, rendiciones, trazabilidad y soporte en cada etapa del viaje.',
    
    'project.tali.role-text': 'Me desempeñé como Researcher / Service Designer, trabajando en equipo freelance con otras 2 diseñadoras. Acompañé el proyecto desde su fase cero hasta la entrega de la propuesta completa.',
    
    'project.tali.team-1': 'Yo (Researcher / Service Designer)',
    ...
    'project.tali.process-intro': 'Trabajamos con un enfoque de diseño centrado en el usuario, combinando investigación cualitativa con diseño estratégico y construcción de marca.',
    ...
    'project.tali.process-1-item-3': 'Detección de fricciones comunes en la gestión de viajes corporativos: visibilidad, trazabilidad, autorizaciones, rendiciones, soporte',
    ...
    'project.tali.finding-1-text': 'Un solo viaje corporativo es percibido y gestionado de forma completamente diferente por el viajero, el planificador, el aprobador y el equipo de seguimiento. Cada rol tiene necesidades, fricciones y expectativas distintas que deben ser atendidas sin crear complejidad innecesaria.',
    
    'project.tali.finding-2-title': 'Es fácil caer en flujos infinitos',
    'project.tali.finding-2-text': 'Si no se definen límites claros por usuario y contexto, los flujos pueden volverse infinitamente complejos. Fue crucial establecer qué acciones correspondían a cada rol y en qué momento del journey.',
    
    'project.tali.finding-3-title': 'Las necesidades cambian en cada momento del viaje',
    'project.tali.finding-3-text': 'Antes del viaje: planificación y aprobaciones. Durante el viaje: soporte y modificaciones. Después del viaje: rendiciones y cierres. La plataforma debe anticiparse a estos momentos cambiantes.',
    
    'project.tali.finding-4-title': 'La coherencia digital-física es fundamental',
    'project.tali.finding-4-text': 'En entornos corporativos, la coherencia entre lo digital (plataforma) y lo impreso (vouchers, reportes) es crucial para la percepción de profesionalismo y confiabilidad del servicio.',
    
    'project.tali.finding-5-title': 'La visibilidad genera confianza',
    'project.tali.finding-5-text': 'Tanto viajeros como supervisores necesitan visibilidad completa del estado del viaje en tiempo real. La trazabilidad no es un "nice to have", es un requisito fundamental.',
    
    'project.tali.result-1-value': 'Perfiles de usuario definidos',
    'project.tali.result-2-value': 'Entrega completa',
    ...
    'project.tali.reflection-1': 'Este proyecto me ayudó a comprender mejor los retos de servicios complejos con múltiples usuarios simultáneos, y la importancia de hacer visual incluso lo que todavía no existe. Trabajar en un equipo pequeño y multidisciplinario fue enriquecedor: cada una aportaba su expertise y juntas construimos algo coherente.',
    'project.tali.reflection-2': 'Aunque el proyecto no se implementó, el aprendizaje fue invaluable. Diseñar desde cero te obliga a cuestionar cada decisión: ¿por qué este flujo y no otro? ¿Por qué este nombre? ¿Qué problema real estamos resolviendo? No tener restricciones de sistemas legacy fue liberador, pero también exigió mayor rigor estratégico.',
    'project.tali.reflection-3': 'Crear la marca TALI desde cero, incluyendo naming, identidad y propuesta de valor, fue una experiencia completa de diseño estratégico que me mostró cómo el diseño de servicios y el branding deben caminar juntos desde el primer día.',
    
    'sidebar.interested-text-tali': 'Si quieres conocer más sobre mi trabajo en diseño de servicios complejos y creación de marca, hablemos.',

     // PROYECTO LUMI
    'project.lumi.hero-title': 'Lumi - Aprender nunca fue tan emocionante',
    'project.lumi.hero-subtitle': 'Plataforma de aprendizaje personalizado que transforma la educación en una experiencia emocionante y llena de propósito, donde cada estudiante descubre su propio camino.',
    
    // Context
    'project.lumi.context-text-1': 'Lumi nació como un proyecto académico de 4 meses en el que exploramos cómo las tecnologías disruptivas —específicamente la inteligencia artificial— podían transformar la experiencia educativa. A lo largo del curso, trabajamos con distintas herramientas de IA mientras aplicábamos metodologías de Design Thinking.',
    'project.lumi.context-text-2': 'El proyecto surgió de problemáticas reales compartidos por dos compañeras del equipo que trabajan en el área de innovación educativa de colegios reconocidos en Perú. Identificamos que las plataformas de e-learning actuales no personalizan realmente la experiencia de aprendizaje, sino que entregan contenido genérico que no considera el estilo cognitivo, el momento vital ni las motivaciones de cada usuario.',
    'project.lumi.context-text-3': 'Lumi fue diseñada para poner al ser humano en el centro del proceso educativo, creando rutas de aprendizaje adaptativas, gamificadas y emocionalmente significativas.',
    
    // Challenge
    'project.lumi.challenge-text': '¿Cómo diseñar una plataforma de aprendizaje que realmente se adapte a cada persona, motivando el progreso constante sin perder de vista el propósito y la emoción de aprender?',
    
    // Role
    'project.lumi.role-text': 'Como Service Designer y Project Manager del equipo de 4 personas, lideré la conceptualización estratégica de Lumi, coordinando el uso de herramientas de IA y facilitando el proceso de diseño colaborativo.',
    ...
    'project.lumi.resp-3': 'Coordinar la integración de herramientas de IA en el proceso (ChatGPT, Gemini, Claude, Storm, Manus, Lovable, Zapier)',
    ...
    // Process
    'project.lumi.process-intro': 'Aplicamos un proceso de Design Thinking iterativo, enriquecido con herramientas de inteligencia artificial en cada etapa. El proyecto evolucionó durante 4 meses, agregando capas de complejidad y funcionalidad conforme explorábamos nuevas tecnologías.',
    
    'project.lumi.process-1-title': '1. Empatizar e Investigar',
    'project.lumi.process-1-text': 'Trabajamos directamente con dos expertas en innovación educativa de colegios en Perú para identificar problemas reales:',
    ...
    'project.lumi.process-1-tools': 'Herramientas usadas: ChatGPT (análisis de insights), Excalidraw (mapeo colaborativo), Miro (brainstorming visual)',
    ...
    'project.lumi.process-2-tools': 'Herramientas usadas: Gemini (generación de ideas), Claude (refinamiento conceptual), Storm (investigación de mercado)',
    ...
    'project.lumi.value-1-text': 'No más contenido genérico. Lumi identifica cómo aprendes mejor y crea rutas personalizadas según tu estilo cognitivo, intereses y ritmo. Tu camino es único.',
    'project.lumi.value-2-title': 'Recompensas Reales',
    'project.lumi.value-2-text': 'Los LumiCoins no son medallas virtuales: se canjean por mentorías con expertos, recursos premium, certificados verificados y becas. Tu esfuerzo tiene valor tangible.',
    'project.lumi.value-3-title': 'Para Todos los Estilos',
    'project.lumi.value-3-text': 'Desde estudiantes de 12 años hasta jóvenes adultos de 25+. Materias escolares, habilidades para la vida (adulting) y refuerzo académico en una sola plataforma.',
    'project.lumi.value-4-title': 'IA al Servicio del Aprendiz',
    'project.lumi.value-4-text': 'Desde personalización hasta analítica predictiva para anticipar abandonos, cada innovación potencia la experiencia humana sin perder la calidez del acompañamiento.',
    
    // Los 5 Estilos
    'project.lumi.styles-title': 'Los 5 Estilos de Aprendizaje',
    'project.lumi.styles-intro': 'Lumi reconoce que no todos aprendemos igual. Por eso creamos 5 perfiles únicos que adaptan la experiencia educativa a tu forma natural de procesar información:',
    'project.lumi.style-1-name': 'Visionauta',
    'project.lumi.style-1-desc': 'Aprende viendo: Infografías, diagramas, videos visuales, mapas mentales y contenido gráfico que transforma ideas abstractas en imágenes claras.',
    'project.lumi.style-2-name': 'Audioexplorador',
    'project.lumi.style-2-desc': 'Aprende escuchando: Podcasts, explicaciones narradas, debates, audiolibros y discusiones que convierten el conocimiento en conversación.',
    'project.lumi.style-3-name': 'Manos a la Obra',
    'project.lumi.style-3-desc': 'Aprende haciendo: Experimentos prácticos, proyectos reales, simulaciones interactivas y talleres donde la teoría cobra vida.',
    'project.lumi.style-4-name': 'LogiMaster',
    'project.lumi.style-4-desc': 'Aprende razonando: Problemas lógicos, análisis estructurado, pensamiento crítico y desafíos que conectan causa y efecto.',
    'project.lumi.style-5-name': 'Colab Hero',
    'project.lumi.style-5-desc': 'Aprende colaborando: Trabajo en equipo, discusiones grupales, proyectos sociales y construcción colectiva del conocimiento.',
    ...
    'project.lumi.coins-intro': 'Los LumiCoins son la moneda educativa de la plataforma, pero a diferencia de otros sistemas de gamificación, tienen valor tangible. No son puntos vacíos ni medallas decorativas: son un reconocimiento real de tu esfuerzo y progreso.',
    'project.lumi.coins-step-1-title': 'Gana',
    'project.lumi.coins-step-1-text': 'Completa módulos, alcanza metas, mantén tu racha de aprendizaje y participa activamente en la plataforma.',
    ...
    // Diferenciadores
    'project.lumi.diff-1': '5 Estilos de Aprendizaje: Sistema único de personalización que adapta contenido según cómo procesas información (visual, auditivo, kinestésico, lógico, colaborativo)',
    'project.lumi.diff-2': 'LumiCoins con valor real: Sistema de recompensas que se canjea por mentorías, recursos premium, certificados y becas',
    'project.lumi.diff-3': 'Rutas dinámicas: Experiencias que se adaptan continuamente según avance, perfil y feedback del usuario',
    'project.lumi.diff-4': 'Adulting + Academia: Combina materias tradicionales con habilidades para la vida real (impuestos, finanzas personales, vida profesional)',
    'project.lumi.diff-5': 'Tecnología + Humanidad: Combina IA avanzada con acompañamiento humano cercano y empático',
    'project.lumi.diff-6': 'Accesibilidad total: Diseñada para múltiples dispositivos y perfiles, desde nativos digitales hasta personas con baja afinidad tecnológica',
    
    // Results
    'project.lumi.result-1-value': 'Estilos de aprendizaje personalizados',
    ...
    // AI Tools
    'project.lumi.ai-intro': 'Uno de los aspectos más innovadores de este proyecto fue la integración estratégica de múltiples herramientas de inteligencia artificial en cada fase del proceso:',
    ...
    'project.lumi.reflection-1': 'Este proyecto me enseñó que las herramientas de inteligencia artificial son amplificadores extraordinarios del proceso creativo, pero solo cuando se guían con intención estratégica y empatía profunda hacia los usuarios finales.',
    'project.lumi.reflection-2': 'Lumi comenzó como un ejercicio académico, pero se transformó en una reflexión sobre cómo diseñamos experiencias educativas en el siglo XXI. Aprendí que la verdadera innovación no está en usar la tecnología más avanzada, sino en ponerla al servicio de las necesidades reales de las personas.',
    'project.lumi.reflection-3': 'Crear los 5 estilos de aprendizaje y el sistema de LumiCoins me enseñó que la gamificación tiene sentido solo cuando genera valor tangible. No se trata de agregar puntos y medallas, sino de reconocer el esfuerzo real con oportunidades reales.',
    'project.lumi.reflection-4': 'Liderar este proyecto también fortaleció mi capacidad para coordinar equipos multidisciplinarios, integrar herramientas disruptivas en procesos de diseño tradicionales, y mantener el foco en el valor humano sin perder de vista la viabilidad técnica.',
    'project.lumi.reflection-5': 'Actualmente, llevando Lumi al código, reafirmo mi convicción: el diseño estratégico y el desarrollo no son etapas separadas, son conversaciones continuas que deben mantenerse conectadas desde el primer día.',
  ...
  en: {
    ...
    'project.bid.desc': 'Strategic redesign of internal services at the IDB Secretariat. 80 interviews across 7-10 countries, diagnosis of 50+ systems, and redesign of invisible processes to improve coordination and reduce operational overload.',
    'project.bid.metric1': 'Interviews',
    ...
    'project.agenda.hero-subtitle': 'Redesign of the web appointment system during the pandemic, enabling fully digital medical scheduling coordinated with teleconsultation. A project that transformed care for over 70,000 patients.',

    'project.agenda.context-text-1': 'During the 2020 pandemic, Clínica Alemana urgently needed to transform its care channels to enable fully online medical appointment scheduling. This solution had to be developed in parallel with a new teleconsultation platform, ensuring an integrated, seamless, and secure experience for patients and internal teams.',
    'project.agenda.context-text-2': 'The challenge wasn\'t just technological: many people were still unfamiliar with digital environments, and the legacy system made navigation difficult for both patients and clinical staff. Additionally, we worked in a complex ecosystem with multiple teams and consultancies developing complementary solutions.',
    ...
    'project.agenda.challenge-text': 'How to design a new digital medical appointment channel that coherently connected with the teleconsultation service, improving patient experience in a context of high health urgency, coordinating multiple teams and platforms in parallel?',

    'project.agenda.role-text': 'As UX/Service Designer at Continuum, I worked for 14 months on this project, leading the strategic service design, facilitating workshops, guiding the experience vision, and aligning flows between different systems, teams, and channels.',
    'project.agenda.team-1': 'Me (UX/Service Designer + Researcher)',
    'project.agenda.team-2': '1 UX/UI Designer',
    'project.agenda.team-3': '7 Developers',
    'project.agenda.team-4': '1 Project Manager',
    ...
    'project.agenda.process-intro': 'We implemented an iterative user-centered design process, constantly adapting to emerging needs during the pandemic and coordinating multiple simultaneous work fronts.',
    ...
    'project.agenda.process-1-item-3': 'Identification of critical points: slowness, duplicate steps, unclear language, difficulty in self-managing changes',
    ...
    'project.agenda.result-2-value': 'User satisfaction',
    'project.agenda.result-3-value': 'Doctors incorporated',
    'project.agenda.result-4-value': 'Participation at pandemic peak',
    ...
    'project.agenda.learning-1-text': 'Working simultaneously with Continuum, Globant, 2Brains, and Clínica Alemana\'s internal team taught me the importance of maintaining clear communication channels, shared documentation, and a unified experience vision even when teams work on different components.',
    'project.agenda.learning-2-title': 'Resilient design in times of uncertainty',
    'project.agenda.learning-2-text': 'The pandemic forced us to design with extreme flexibility: requirements changed weekly, priorities adjusted according to the health emergency, and we had to balance speed with quality. I learned to create adaptable design systems that could evolve without collapsing.',
    'project.agenda.learning-3-title': 'The importance of incremental design',
    'project.agenda.learning-3-text': 'The progressive launch approach (friends & family → general public → continuous improvement) allowed validating hypotheses in real environments before scaling, reducing risks and improving the service\'s final quality.',

    'project.agenda.reflection-quote': 'Designing in sync with multiple teams, without losing sight of the user.',
    'project.agenda.reflection-1': 'This project showed me that designing a web appointment system may seem like a technical challenge, but in this case, it was also a deep exercise in empathy, process clarity, and resilience in the midst of chaos. Coordinating with multiple consultancies and internal teams, each with their own methodologies and priorities, required not just design skills but also diplomacy, strategic communication, and a clear vision of the common north.',
    'project.agenda.reflection-2': 'Supporting this channel for 14 months allowed me to see how digital experience can transform from the essential, growing with purpose and meaning. Seeing how over 70,000 people could access quality medical care in critical moments, many with little previous technological experience, reaffirmed my conviction about the power of people-centered design.',
    'project.agenda.reflection-3': 'This project not only transformed Clínica Alemana\'s service; it also transformed my understanding of service design in complex ecosystems and my ability to maintain human focus even under extreme pressure.',

    'project.agenda.visual-findings-desc': 'Findings presentation in storytelling mode to communicate insights to the team and stakeholders.',
    ...
    'project.agenda.visual-blueprint-desc': 'Understanding the areas, the service, and how it should integrate with the clinic\'s existing systems.',
    ...
    'project.teleconsulta.hero-subtitle': 'Design from scratch of a medical video call platform integrated with the web appointment system. Automation of payments, prescription delivery, and clinical document management with 40% reduction in complaints.',

    'project.teleconsulta.context-text-1': 'During 2020, in the midst of the pandemic, we accompanied Clínica Alemana Santiago in designing its own teleconsultation platform. Although development was carried out in parallel with the redesign of its Web Appointment System, both teams worked in a coordinated manner to ensure a smooth and continuous experience for patients and doctors.',
    'project.teleconsulta.context-text-2': 'This new solution had to respond to specific challenges of the health context, facilitate the digital experience for audiences not yet accustomed to this type of platform, and at the same time, free up the operational burden faced by the medical team.',
    'project.teleconsulta.context-text-3': 'The project was developed in a complex ecosystem, coordinating with multiple teams and consultancies:',

    'project.teleconsulta.challenge-text': 'How to design a medical teleconsultation platform from scratch, in the midst of a health emergency, that would allow safe and efficient remote care, without increasing the operational burden on medical personnel?',

    'project.teleconsulta.role-text': 'I participated as a service designer, ensuring that the care experience was consistent and clear across all touchpoints. I supported the process for 14 months (the team continued after my departure), applying an incremental design approach that allowed us to launch an initial version in 6 months and continue iterating with value improvements for users and teams.',
    ...
    'project.teleconsulta.process-intro': 'The project was carried out in a context of high uncertainty, with a very tight deadline and great challenges for conducting research or field testing. Even so, we designed a process focused on deeply understanding the problems of patients, doctors, and administrative teams.',
    ...
    'project.teleconsulta.reflection-1': 'This project was both a technical and emotional challenge. We worked with urgency, but without losing human focus. The decision to communicate findings through a cinematic narrative (the "acts" of Mariana and Fernando) wasn\'t just a creative choice, but strategic: we needed stakeholders, developers, and medical teams to viscerally understand users\' pain points.',
    'project.teleconsulta.reflection-2': 'Seeing how the story resonated in presentations, how teams began referring to "Act 4" or "the Wizard of Oz problem," taught me that service design isn\'t just mapping flows, but creating shared languages that facilitate decision-making.',
    'project.teleconsulta.reflection-3': 'The depth of research, attention to details, and coordination between multiple teams made possible something that seemed unfeasible in the midst of uncertainty. Supporting this transformation from service design was a lesson in empathy, strategy, and commitment to real value.',
    'project.teleconsulta.reflection-4': 'This project reaffirmed my conviction: the best solutions are born when we combine methodological rigor with deep human empathy, and when we know how to communicate our findings in a way that inspires action.',

    'project.teleconsulta.visual-blueprint-desc': 'Complete service map showing all touchpoints, actors, and systems involved in the teleconsultation experience.',
    ...
    'project.teleconsulta.visual-storytelling-desc': 'Visual storytelling with Mariana and Fernando\'s narrative, structured as a film with acts representing service pain points.',
    ...
    'project.cubico.hero-title': 'Cubico - Improve Your Energy Challenge',
    'project.cubico.hero-subtitle': 'Collaborative educational program that empowered 85 young people in Seville to design sustainable solutions in their community, training 12 teachers in people-centered design methodologies.',

    'project.cubico.context-text-1': 'In collaboration with Fruta, a consultancy specialized in design for sustainability, and Cubico Iberia, a leading company in sustainable investments, we developed a pilot corporate social responsibility (CSR) program in Morón de la Frontera, Seville.',
    'project.cubico.context-text-2': 'The goal was to strengthen the link between education, sustainability, and renewable energy, empowering young people to become agents of change in their communities. This program sought not only to educate about sustainability, but to give students real design tools to identify and solve local problems.',
    'project.cubico.context-text-3': 'The project was developed in two schools in the area, working with both ESO (Compulsory Secondary Education) and Vocational Training students, each with different needs and contexts.',

    'project.cubico.challenge-text': 'Design and implement an educational program that integrated innovation, sustainability, and energy, aimed at secondary and vocational training students. The challenge was to create a participatory methodology that would allow young people to identify and solve local social and environmental problems, fostering their commitment to sustainable development.',

    'project.cubico.role-text': 'As Service Designer at Fruta, I worked for 5 months on this project, being part of a multidisciplinary team of 4 people.',

    'project.cubico.resp-1': 'Lead the conceptualization of the educational program based on Design Thinking',
    'project.cubico.resp-2': 'Co-design and facilitate 4 initial in-person workshops with young people from the community to understand local issues',
    ...
    'project.cubico.process-intro': 'We designed a participatory process based on Design Thinking, specifically adapted to the educational context and the needs of young people in training. The program was structured in progressive phases that allowed students to move from observation to action.',
    ...
    'project.cubico.methodology-intro': 'The entire program was a careful adaptation of Design Thinking methodology to the educational context. It wasn\'t simply about "teaching" Design Thinking, but creating an experience where young people lived the complete process:',
    'project.cubico.methodology-empathize-title': '🔍 Empathize',
    'project.cubico.methodology-empathize-text': 'Initial workshops with the community allowed students to understand real problems in their environment, not abstract or theoretical problems.',
    'project.cubico.methodology-define-title': '🎯 Define',
    'project.cubico.methodology-define-text': 'With pedagogical tools, teams learned to synthesize information and focus their efforts on specific, actionable problems.',
    'project.cubico.methodology-ideate-title': '💡 Ideate',
    'project.cubico.methodology-ideate-text': 'The interactive game board facilitated collaborative ideation sessions, fostering creativity without losing focus on sustainability.',
    'project.cubico.methodology-prototype-title': '🛠️ Prototype',
    'project.cubico.methodology-prototype-text': 'Students developed tangible prototypes of their solutions, learning about iteration and continuous improvement.',
    'project.cubico.methodology-test-title': '🧪 Test',
    'project.cubico.methodology-test-text': 'Final presentations functioned as validation moments, where they received feedback from teachers, peers, and Cubico representatives.',

    'project.cubico.result-1-value': 'Teachers trained in Design Thinking',
    'project.cubico.result-2-value': 'Participating students (ESO + VT)',
    ...
    'project.cubico.reflection-1': 'This project reaffirmed my conviction about the power of strategic and participatory design to generate social impact. It was inspiring to see how, through appropriate tools and a collaborative approach, young people can become protagonists of change in their communities.',
    'project.cubico.reflection-2': 'Working with teachers was especially enriching: it wasn\'t just about giving them a pedagogical "kit," but co-creating with them, respecting their knowledge of the educational context and adapting our methodologies to their realities. Seeing how they embraced Design Thinking and made it their own was one of the project\'s greatest achievements.',
    'project.cubico.reflection-3': 'Additionally, it strengthened my ability to adapt design methodologies to diverse educational and cultural contexts. I learned that designing for education isn\'t just creating content, but creating experiences that transform the way young people and teachers relate to problems in their environment.',
    'project.cubico.reflection-4': 'Seeing the winning project implemented and generate real benefits in Morón de la Frontera was confirmation that when we empower people with design tools, they don\'t just solve problems: they create possible futures.',
    ...
    'project.cubico.visual-booklet-text': 'If you want to learn more about what we did with the Morón de la Frontera community, you can read our booklet, is available only in Spanish.',
    'project.cubico.visual-booklet-btn': 'Download booklet',

    'sidebar.project-reach': 'Project Scope',
    'sidebar.workshops-discovery': 'Discovery Workshops',
    'sidebar.workshops-presential': 'in-person',
    'sidebar.teacher-workshops': 'Teacher Workshops',
    'sidebar.per-school-total': 'per school (4 total)',
    'sidebar.digital-sessions': 'Digital Sessions',
    'sidebar.with-students': 'with students',
    'sidebar.teachers-label': 'Teachers',
    'sidebar.trained': 'trained',
    'sidebar.students-label': 'Students',
    ...
    'project.upc.hero-subtitle': 'Omnichannel redesign of the admissions experience at UPC, integrating physical spaces and digital platform for prospective students and parents. Project with real testing at locations with ~30 users in high-traffic context.',

    // Context
    'project.upc.context-text-1': 'The Universidad Peruana de Ciencias Aplicadas (UPC) sought to redesign its care experience for prospective students and parents at its physical locations. Our goal from Continuum was to improve both the process and physical space, proposing omnichannel solutions that aligned digital and in-person experience during the admissions process.',
    'project.upc.context-text-2': 'The organizational context was complex: At the kick-off, we discovered there were 3 similar projects running in parallel within the university, each working in isolation (in silos) on digitizing enrollment. Our team managed to develop valuable findings and concrete proposals that were differentiated by a comprehensive approach: we not only designed the digital experience, but also the complete redesign of the physical admissions space.',
    'project.upc.context-text-3': 'Part of our solutions were implemented directly at physical locations, while other inputs were absorbed by a different project that had greater political weight within the institution. Even so, the impact of our proposal was significant and validated with real testing under high-traffic conditions.',

    // Challenge
    'project.upc.challenge-text': 'Ensure that prospective students and parents have a good experience in the admissions process, leading them to choose and remain at UPC. Focusing on a single channel would make us think of a siloed solution. It is necessary to see the service as one great omnichannel experience.',

    // Role
    'project.upc.role-text': 'As Service Designer at Continuum, I participated in all stages of the project: from initial research, ideation, prototyping and testing solutions, to final delivery.',
    ...
    // Process
    'project.upc.process-intro': 'We implemented a user-centered design process with a focus on omnichannel, ensuring each touchpoint was integrated and supported by the same information base.',

    'project.upc.process-1-title': '1. Discovery & Current Experience Mapping',
    'project.upc.process-1-text': 'Deep research of current context:',
    'project.upc.process-1-item-1': 'Field research: direct observation and interviews with prospective students, parents, and admissions staff',
    'project.upc.process-1-item-2': 'Mapping of prospective student\'s current journey, from first contact to process closure',
    'project.upc.process-1-item-3': 'Identification of frictions: duplicate information, low visibility of academic offerings, uncomfortable or unintuitive physical environments',
    ...
    'project.upc.process-2-item-2': 'Generation of improvement concepts: Prospective Student Portal (centralized digital platform), Physical location redesign (welcome areas, career visualization, barrier-free spaces), "Genius" roles redesigned as guide, Ticketing system on iPad, Interactive cost simulator',
    ...
    'project.upc.process-3-item-6': 'Identification of aspects increasing perception of closeness: Elimination of counter as barrier, Comfortable living room-style furniture, Shared screen use (iPad/laptops) between advisor and prospective student, Visible and accessible information from entrance',
    ...
    'project.upc.finding-1-title': '🔗 Omnichannel is key',
    'project.upc.finding-1-text': 'All touchpoints must complement each other and be supported by a single consolidated information base. Channels cannot function in isolation: digital experience must reflect and enhance physical experience, and vice versa.',

    'project.upc.finding-2-title': '👨‍👩‍👧 Prospective Students vs Parents: different needs',
    'project.upc.finding-2-text': 'Prospective students quickly grasp the use and value of the digital platform. Parents need to complement it with human contact. This confirmed the solution had to be hybrid, not just digital.',

    'project.upc.finding-3-title': '📅 Key standardized moments by channel',
    'project.upc.finding-3-text': 'It\'s important to define which moments should be in-person and which digital: In-person: Take guided tours, take admissions exam. Digital: Schedule tours, schedule and pay for exam, view results.',

    'project.upc.finding-4-title': '🔗 Early registration = solid bond',
    'project.upc.finding-4-text': 'Registration on the prospective student platform should be as early as possible as it\'s a way to solidify their bond with the university until they decide to enroll.',

    'project.upc.finding-5-title': '🪑 Round tables and comfortable furniture generate closeness',
    'project.upc.finding-5-text': 'Care at round tables and comfortable furniture generate closeness between prospective student and advisor. This environment also makes waiting more pleasant.',

    'project.upc.finding-6-title': '💻 Shared iPads and laptops improve transparency',
    'project.upc.finding-6-text': 'Care systems need to be available for laptops and iPads as these improve interaction between prospective student and advisor since both see the same information and it feels more transparent.',

    'project.upc.finding-7-title': '🎯 The "Genius" role as orchestrator',
    'project.upc.finding-7-text': 'The Genius fulfills an important role and should orchestrate the entire scene. That\'s why it\'s important to arm them with necessary tools and information. This role welcomes, guides, and resolves initial doubts without physical barrier.',

    'project.upc.finding-8-title': '📚 Complete offering visibility from entrance',
    'project.upc.finding-8-text': 'Showing the complete career offerings from the entrance is important for those seeking information. Users were positively surprised to discover careers they didn\'t know existed at the university.',
    ...
    'project.upc.result-2-value': 'Locations with physical testing',
    ...
    'project.upc.learning-1-text': 'Discovering 3 parallel projects working in silos was a diplomatic as well as methodological challenge. I learned that in complex organizations, service design must be even more rigorous, empathetic, and diplomatic. Having the best solution isn\'t enough: you must navigate political dynamics and power tensions.',

    'project.upc.learning-2-title': 'Testing in real context is invaluable',
    'project.upc.learning-2-text': 'Testing for 4 hours at each location, on high-traffic days, with real users (not recruited), gave us insights no usability lab could replicate. Seeing how advisors moved between tables, how parents reacted to the lack of counter, how prospective students discovered careers on the wall... that only happens in real context.',

    'project.upc.learning-3-title': 'Omnichannel is not optional',
    'project.upc.learning-3-text': 'Young people prefer digital control, parents value human contact. Physical experience must be part of the service, not just support. Spaces must reflect trust, transparency, and visual order. No channel can function in isolation.',

    // Reflections
    'project.upc.reflection-quote': 'Designing is also navigating complex organizational realities.',
    'project.upc.reflection-1': 'This project was a political and operational challenge, but also an opportunity to learn to sustain user vision amid power tensions and institutional priorities. Seeing that part of our physical design was implemented, and that the digital flow was adopted almost intact (though with different visualization), was confirmation that when we design with rigor and real evidence, value imposes itself.',
    'project.upc.reflection-2': 'I also learned that sometimes the best projects aren\'t those implemented 100%, but those that manage to change conversations, influence decisions, and demonstrate that another way of doing things is possible. Even when our deliverables were "absorbed" by other projects with more political weight, the fact they used our insights and flows is a victory for user-centered design.',
    ...
    'project.upc.visual-external-title': 'External Resources',
    'project.upc.visual-external-text': 'Case published by Continuum',
    ...
    'project.spotify.hero-subtitle': 'Qualitative research on Spotify Premium subscription patterns in Peru. Bilingual comparative study that refuted the client\'s initial hypothesis, revealing insights about user behavior in emerging markets.',
    
    // Context
    'project.spotify.context-text-1': 'This project emerged from a partnership between Spotify, a German consultancy, and Ayer Viernes (Chile), who invited us to participate as the research team for the Peruvian market. Spotify had detected an unusual pattern: in countries like Peru, many users subscribed directly to Premium without first using the free plan, contrary to what occurred in other markets.',
    'project.spotify.context-text-2': 'The global team assumed this was due to a perception of greater value in the paid plan, but there was no qualitative data to support it. It was necessary to investigate whether this hypothesis held in the local context and, if not, understand what was really happening.',
    'project.spotify.context-nda': 'Note: This project was under NDA (Non-Disclosure Agreement), so the information shared here is limited to methodological aspects, general learnings, and my role in the process, without revealing sensitive or proprietary client data.',
    
    // Challenge
    'project.spotify.challenge-text': 'Why do users in Peru subscribe directly to Spotify Premium without using the freemium space the platform offers? Do they really value the paid plan more, or are there other factors at play?',
    ...
    // Process
    'project.spotify.process-intro': 'We designed a rigorous, bilingual, and culturally sensitive qualitative research process that would allow us to validate or refute the client\'s initial hypothesis.',
    ...
    'project.spotify.process-1-item-1': 'Initial hypothesis: "In Peru, users subscribe directly to Spotify Premium because they perceive more value in the paid plan than in the free one"',
    ...
    'project.spotify.findings-intro': 'The research revealed important findings that changed the client\'s understanding of the Peruvian market:',
    
    'project.spotify.finding-1-title': '🔍 The hypothesis was refuted',
    'project.spotify.finding-1-text': 'Users did NOT value the Premium plan more per se. The reality was more complex: many had already had prior contact with Spotify (through family accounts, old emails, or previous trial periods), which led them to subscribe directly without exploring freemium again.',
    
    'project.spotify.finding-2-title': '📱 Cultural and technological context',
    'project.spotify.finding-2-text': 'We identified specific barriers in the Peruvian market related to digital trust, payment methods, translated terminology, and technology usage patterns that differed significantly from developed markets.',
    
    'project.spotify.finding-3-title': '🎵 Competition and alternatives',
    'project.spotify.finding-3-text': 'Peruvian users used multiple platforms simultaneously (YouTube, pre-installed mobile services, etc.), each for different needs, which complicated the adoption journey.',
    
    'project.spotify.finding-4-title': '💡 Identified opportunities',
    'project.spotify.finding-4-text': 'We proposed specific improvements in communication, onboarding, content localization, and conversion strategies adapted to local market realities.',
    
    // Results
    'project.spotify.result-1-value': 'People screened',
    'project.spotify.result-2-value': 'In-depth interviews',
    ...
    'project.spotify.learning-1-text': 'This project taught me that the client\'s initial hypotheses, although logical, don\'t always reflect reality. Rigorous qualitative research is essential to reveal users\' true motivations and behaviors, especially in markets with different cultural and economic contexts.',
    
    'project.spotify.learning-2-title': 'Bilingual research and cultural sensitivity',
    'project.spotify.learning-2-text': 'Working in Spanish with Peruvian users and then translating findings to English for a global team requires not only language proficiency but deep understanding of cultural nuances that aren\'t always evident in a literal translation.',
    
    'project.spotify.learning-3-title': 'Listen without assuming',
    'project.spotify.learning-3-text': 'Quantitative data showed a pattern (direct Premium subscription), but only qualitative research revealed the real "why": previous experiences with the platform, not perception of greater value. This project reinforced my conviction about the power of in-depth interviews.',
    
    // Reflections
    'project.spotify.reflection-quote': 'Data without context can reinforce wrong ideas.',
    'project.spotify.reflection-1': 'This study confirmed that listening to users changes business decisions. In this case, it allowed avoiding investing resources in misguided strategies and better aligning with local market realities.',
    'project.spotify.reflection-2': 'Working with a global client like Spotify, under NDA, and with the responsibility of translating not just languages but cultural contexts, was a formative challenge that strengthened my skills as a researcher. I learned that good research isn\'t just about collecting data, but interpreting it with empathy and rigor, communicating it clearly, and above all, having the courage to refute hypotheses when evidence demands it.',
    'project.spotify.reflection-3': 'This project also showed me the importance of working in multicultural and multilingual teams, where each member contributes unique perspectives that enrich the final analysis.',
...
// MINCETUR PROJECT - ENGLISH
    ...
    'project.mincetur.hero-subtitle': 'Intensive 3-day workshop with CITE leaders from all over Peru to co-create a replicable management model. Designed tools remained in use 2 years later.',
    
    'project.mincetur.context-text-1': 'This project was an intensive 3-day workshop requested by the Ministry of Foreign Trade and Tourism (MINCETUR) of Peru, with the objective of accompanying CITE (Centers for Productive Innovation and Technology Transfer) leaders in building a replicable management model aligned with State requirements.',
    'project.mincetur.context-text-2': 'CITEs are strategic centers that drive innovation in sectors such as crafts and tourism, but faced challenges in structuring their management plans, optimizing budget use, and meeting government-mandated KPIs. The workshop sought to translate technical state language into an accessible and useful format for these center leaders.',
    'project.mincetur.context-text-3': 'Working from Creative Lab, we created our own tools, adapted existing ones, and facilitated the entire process from start to finish. Through collaborative dynamics, we helped participants interpret data, define goals, and clearly visualize their roadmaps.',
    'project.mincetur.context-note': 'Personal note: This was one of my first projects as a Service Designer, and it was an invaluable formative experience in intensive facilitation and strategic tool design.',
    
    'project.mincetur.challenge-text': 'Design and facilitate an intensive 3-day workshop that would allow CITE leaders from all over Peru to co-create a replicable management model, translating complex State requirements into practical and accessible tools they could implement immediately.',
    
    'project.mincetur.role-text': 'I participated as Service Designer at Creative Lab, being the most junior member of the 4-person team. This was one of my first professional projects, and it allowed me to learn about intensive workshop facilitation and strategic design in governmental contexts.',
    ...
    'project.mincetur.process-intro': 'The project was structured in two phases: an intensive 2-week preparation and a 3-day in-person workshop with all CITE leaders.',
    ...
    'project.mincetur.finding-1-text': 'Although all are part of the same MINCETUR system, each CITE faced unique challenges according to their region, resources, and local context. Methodological flexibility was crucial for tools to be useful for everyone.',
    
    'project.mincetur.finding-2-title': 'Translating State language is fundamental',
    'project.mincetur.finding-2-text': 'Government technical requirements were expressed in complex bureaucratic language. Translating this to understandable and visual formats dramatically improved local leaders\' appropriation.',
    
    'project.mincetur.finding-3-title': 'Co-creation from day 1 generates real commitment',
    'project.mincetur.finding-3-text': 'We didn\'t impose a pre-designed model: we facilitated them building it themselves. This active participation (not just consultative) generated genuine appropriation of the process and tools.',
    
    'project.mincetur.finding-4-title': 'Visualizing objectives strengthens purpose',
    'project.mincetur.finding-4-text': 'Seeing their goals, KPIs, and responsibilities visually represented helped teams understand the complete picture and feel empowered to execute.',
    
    'project.mincetur.result-1-value': 'Days of intensive workshop',
    'project.mincetur.result-2-value': 'Participating CITE leaders',
    ...
    'project.mincetur.learning-1-text': 'As the most junior member of the team, this workshop taught me that facilitating isn\'t just guiding dynamics, but holding safe spaces where people feel capable of creating. Seeing how CITE leaders appropriated the tools was my first great lesson about the power of participatory design.',
    
    'project.mincetur.learning-2-title': 'Adapting is more valuable than imposing',
    'project.mincetur.learning-2-text': 'There is no "one model" that works for everyone. I learned that the best tools are those users understand, adapt, and make their own. In intensive facilitation processes, adapting the method to the user\'s pace and language is more important than following the perfect structure.',
    
    'project.mincetur.learning-3-title': 'Design impact isn\'t measured only at the end',
    'project.mincetur.learning-3-text': 'Finding out 2 years later that CITEs were still using the tools we created was confirmation we designed something truly useful. True success isn\'t just delivering a workshop, but creating sustainable value.',
    
    'project.mincetur.learning-4-title': 'Designing for the public sector requires special sensitivity',
    'project.mincetur.learning-4-text': 'Working with government entities involves navigating bureaucracy, technical language, and multiple stakeholders. This project taught me to translate complexity into clarity without losing rigor.',
    
    'project.mincetur.reflection-quote': 'The most powerful tool is one that users make their own.',
    'project.mincetur.reflection-1': 'This project taught me that in intensive facilitation processes, the key is to accompany with empathy and clarity. It\'s not about arriving with pre-built solutions, but creating the space and tools for people to build their own answers.',
    'project.mincetur.reflection-2': 'Being one of my first professional projects, it marked me deeply. I learned that service design isn\'t just methodology, but also active listening, flexibility, and trust in people\'s ability to solve their own challenges when given the right tools.',
    'project.mincetur.reflection-3': 'Seeing that 2 years later CITEs were still using what we co-created together was the greatest validation: we designed something that truly served them. And that, for me, is the true success of strategic design.',
    ...
    'project.tali.hero-subtitle': 'Freelance project to create a fully digital travel agency oriented to corporations. Research, experience design for 4 user profiles, and complete brand creation from scratch.',
    
    'project.tali.context-text-1': 'This project was born as a private initiative to create a fully digital travel agency oriented to employees of large corporations. It involved designing a service that would allow planning, visualizing, and managing corporate travel from different devices and roles, without friction.',
    'project.tali.context-text-2': 'We worked as a 3-person freelance team for 2 months, developing everything from scratch: market research, user definition, experience design, brand creation, naming, and complete value proposition.',
    'project.tali.context-text-3': 'Although the project wasn\'t implemented due to funding issues, we delivered a complete package that included qualitative research, insight clustering, differentiated user flow design, brand identity (including the name TALI), and functional landing page. It was a valuable experience due to the complexity of users, use cases, and flows involved.',
    
    'project.tali.challenge-text': 'Design from scratch a digital platform that would allow multiple user profiles (travelers, supervisors, HR, support) to manage corporate travel smoothly, considering the complexities of authorizations, expense reports, traceability, and support at each stage of the trip.',
    
    'project.tali.role-text': 'I worked as Researcher / Service Designer, working in a freelance team with 2 other designers. I accompanied the project from its zero phase to the delivery of the complete proposal.',
    
    'project.tali.team-1': 'Me (Researcher / Service Designer)',
    'project.tali.team-2': '1 Service Designer',
    ...
    'project.tali.process-intro': 'We worked with a user-centered design approach, combining qualitative research with strategic design and brand building.',
    ...
    'project.tali.process-1-item-3': 'Detection of common frictions in corporate travel management: visibility, traceability, authorizations, expense reports, support',
    ...
    'project.tali.finding-1-title': 'The same trip has multiple points of view',
    'project.tali.finding-1-text': 'A single corporate trip is perceived and managed completely differently by the traveler, planner, approver, and tracking team. Each role has different needs, frictions, and expectations that must be addressed without creating unnecessary complexity.',
    
    'project.tali.finding-2-title': 'It\'s easy to fall into infinite flows',
    'project.tali.finding-2-text': 'If clear limits aren\'t defined by user and context, flows can become infinitely complex. It was crucial to establish which actions corresponded to each role and at what moment in the journey.',
    
    'project.tali.finding-3-title': 'Needs change at each moment of the trip',
    'project.tali.finding-3-text': 'Before the trip: planning and approvals. During the trip: support and modifications. After the trip: expense reports and closures. The platform must anticipate these changing moments.',
    
    'project.tali.finding-4-title': 'Digital-physical coherence is fundamental',
    'project.tali.finding-4-text': 'In corporate environments, coherence between digital (platform) and printed (vouchers, reports) is crucial for the perception of professionalism and service reliability.',
    
    'project.tali.finding-5-title': 'Visibility generates trust',
    'project.tali.finding-5-text': 'Both travelers and supervisors need complete visibility of trip status in real time. Traceability isn\'t a "nice to have," it\'s a fundamental requirement.',
    
    'project.tali.result-1-value': 'Defined user profiles',
    'project.tali.result-2-value': 'Complete delivery',
    ...
    'project.tali.reflection-quote': 'Designing for multiple profiles at once demands clear limits, strategic vision, and great attention to detail.',
    'project.tali.reflection-1': 'This project helped me better understand the challenges of complex services with multiple simultaneous users, and the importance of making visual even what doesn\'t yet exist. Working in a small multidisciplinary team was enriching: each contributed their expertise and together we built something coherent.',
    'project.tali.reflection-2': 'Although the project wasn\'t implemented, the learning was invaluable. Designing from scratch forces you to question every decision: why this flow and not another? Why this name? What real problem are we solving? Not having legacy system constraints was liberating, but also demanded greater strategic rigor.',
    'project.tali.reflection-3': 'Creating the TALI brand from scratch, including naming, identity, and value proposition, was a complete strategic design experience that showed me how service design and branding must walk together from day one.',
