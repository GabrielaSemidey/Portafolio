...
const translations = {
  es: {
    ...
    "project.agenda.desc":
      "Rediseño de la agenda web para Clínica Alemana durante la pandemia. Alineación con la plataforma de teleconsulta y despliegue incremental en fases.",
    ...
    "project.spotify.desc":
      "Análisis sobre por qué los usuarios en Perú se suscriben al servicio premium sin usar el freemium. Research cualitativo que cambió la estrategia de localización.",
    "project.spotify.metric1": "Usuarios",
    "project.spotify.metric2": "Países",
    "project.spotify.metric3": "Modalidad",
    "project.cubico.desc":
      "Programa educativo colaborativo que empoderó a jóvenes en Sevilla para diseñar soluciones sostenibles en su comunidad.",
    ...
    "project.tali.desc":
      "Portal para gestión de viajes corporativos desde cualquier dispositivo. Proyecto completo de research, diseño y branding.",
    "project.tali.metric1": "Roles",
    "project.tali.metric3": "Estado",
    "project.bid.title": "BID - Secretaría",
    "project.bid.desc":
      "Rediseño estratégico de servicios internos en la Secretaría del BID. 80 entrevistas en 7-10 países, diagnóstico de 50+ sistemas y rediseño de procesos invisibles para mejorar la coordinación y reducir la sobrecarga operativa.",
    ...
    "journey.timeline.2023.meta": "Feb 2023 - Jul 2023 • España",
    "journey.timeline.2023.description":
      "Consultora de diseño sostenible e innovación para proyecto de responsabilidad social corporativa. Facilitación de talleres de co-diseño con estudiantes y profesores.",
    ...
    "journey.timeline.2020.meta": "Ene 2020 - Feb 2022 • Perú/Chile",
    "journey.timeline.2020.description-1": "Lideré investigaciones de usuarios para optimizar productos digitales.",
    "journey.timeline.2020.description-2": "Proyectos destacados:",
    "journey.timeline.2020.description-3":
      "Clínica Alemana (Teleconsulta + Agenda Web), BID (Rediseño de Secretaría), Spotify (Research Premium), UPC.",

    // 2019
    "journey.timeline.2019.title": "Beta User Testing - Service Designer",
    "journey.timeline.2019.meta": "Oct 2019 - Jul 2020 • Perú",
    "journey.timeline.2019.description":
      "Consultora en testeo y validación de productos digitales. Pruebas de usabilidad, análisis de datos cualitativos y cuantitativos con insights accionables.",

    // 2018
    "journey.timeline.2018.title": "Ají limo - UX + Social Media Manager",
    "journey.timeline.2018.meta": "Nov 2018 - Nov 2019 • Perú",
    "journey.timeline.2018.description":
      "Desarrollo de estrategia de marketing digital y UX. Planificación y gestión de contenido para redes sociales. Análisis de KPIs y optimización de campañas.",

    // 2017
    "journey.timeline.2017.title": "CreativeLab - Dir. de Desenredos",
    "journey.timeline.2017.meta": "Nov 2017 - Oct 2018 • Perú",
    ...
    "journey.projects.spotify.title": "Spotify - UX Research",
    "journey.projects.spotify.description":
      "Investigación que cambió la estrategia de localización. Descubrí que los datos sin contexto pueden llevar a decisiones equivocadas.",
    "journey.projects.link": "Ver proyecto completo",
    "journey.projects.btn-all": "Ver todos mis proyectos",
    ...
    "journey.skills.ai-text":
      "uso IA como herramienta de trabajo diaria. No para reemplazar el pensamiento crítico, sino para acelerar tareas repetitivas y explorar soluciones más rápido.",
    "journey.skills.pm":
      "Metodologías ágiles, gestión de stakeholders, coordinación de equipos multidisciplinarios, roadmaps y priorización.",

    // === LEARNING ===
    "journey.learning.badge": "Formación",
    "journey.learning.description": "Certificaciones y formación continua en diseño, desarrollo y gestión de proyectos.",
    "journey.learning.in-progress": "En Progreso",
    "journey.learning.google.subtitle": "Coursera • 6 cursos",
    "journey.learning.progress": "Progreso",
    "journey.learning.started": "Iniciado",
    "journey.learning.mouredev.title": "JavaScript desde cero",
    "journey.learning.completed": "Certificaciones Completadas",
    "journey.learning.product-designer": "Cómo ser Product Designer",
    "journey.learning.psicologia": "Psicología Cognitiva y UX",

    // === FILOSOFÍA ===
    "journey.filosofia.title": "Cómo Trabajo",
    ...
    "journey.filosofia.sistemico-title": "Pensamiento Sistémico",
    "journey.filosofia.sistemico-text":
      "Entiendo cómo cada pieza se conecta con el todo. Diseño soluciones que funcionan en contexto real.",
    "journey.filosofia.colaboracion-title": "Colaboración",
    "journey.filosofia.colaboracion-text":
      "Experiencia trabajando con equipos multidisciplinarios: developers, designers, product managers.",
    "journey.filosofia.impacto-title": "Foco en Impacto",
    "journey.filosofia.impacto-text": "No diseño por diseñar ni codifico por codificar. Busco crear soluciones que aporten valor real.",
    ...
    "project.bid.reflection-2":
      "Diseñar en este contexto me enseñó a moverme entre la empatía profunda y la claridad estratégica. Aprendí a sostener la complejidad, a escuchar sin juzgar, y a facilitar conversaciones difíciles pero necesarias.",
    "project.bid.reflection-3":
      "A veces, el diseño no empieza con una solución brillante, sino con la humildad de reconocer que la dignidad del trabajo de las personas merece un sistema que no las desgaste. Este proyecto me enseñó que el diseño de servicios es un acto de cuidado institucional.",
    "project.bid.reflection-4":
    ...
    "sidebar.interested-text-bid":
      "Si quieres conocer más sobre mi trabajo en rediseño de servicios complejos y liderazgo de equipos, hablemos.",
    ...
    "project.agenda.hero-subtitle":
      "Rediseño de la agenda web durante la pandemia, permitiendo agendamiento médico completamente digital y coordinado con teleconsulta. Un proyecto que transformó la atención de más de 70,000 pacientes.",

    "project.agenda.context-text-1":
    ...
    "project.teleconsulta.context-text-1":
    ...
    "project.teleconsulta.context-text-2":
    ...
    "project.teleconsulta.reflection-3":
    ...
    "project.teleconsulta.reflection-4":
    ...
    "project.cubico.hero-subtitle":
      "Programa educativo colaborativo que empoderó a 85 jóvenes en Sevilla para diseñar soluciones sostenibles en su comunidad, formando a 12 docentes en metodologías de diseño centrado en las personas.",

    "project.cubico.context-text-1":
    ...
    "project.cubico.methodology-empathize-text":
    ...
    "project.cubico.methodology-define-text":
    ...
    "project.cubico.methodology-ideate-text":
    ...
    "project.cubico.methodology-prototype-text":
    ...
    "project.cubico.methodology-test-text":
    ...
    // Context
    "project.spotify.context-text-1":
      "Este proyecto surgió de un partnership entre Spotify, una consultora alemana, y Ayer Viernes (Chile), quienes nos invitaron a participar como equipo de investigación para el mercado peruano. Spotify había detectado un patrón inusual: en países como Perú, muchos usuarios se suscribían directamente a Premium sin usar primero el plan gratuito, contrario a lo que ocurría en otros mercados.",
    "project.spotify.context-text-2":
      "El equipo global asumía que esto se debía a una percepción de mayor valor en el plan pago, pero no había data cualitativa que lo respaldara. Era necesario investigar si esta hipótesis se sostenía en el contexto local y, de no ser así, entender qué estaba realmente sucediendo.",
    "project.spotify.context-nda":
      "Nota: Este proyecto estuvo bajo NDA (Non-Disclosure Agreement), por lo que la información compartida aquí se limita a aspectos metodológicos, aprendizajes generales y mi rol en el proceso, sin revelar datos sensibles o propietarios del cliente.",

    // Challenge
    "project.spotify.challenge-text":
      "¿Por qué los usuarios en Perú se suscriben directamente a Spotify Premium sin hacer uso del espacio freemium que ofrece la plataforma? ¿Realmente valoran más el plan pago, o hay otros factores en juego?",

    // Role
    "project.spotify.role-text":
      "Participé como UX Researcher en un equipo core de 3 personas, siendo la segunda en el equipo de investigación.",
    ...
    "project.spotify.findings-intro":
      "La investigación reveló hallazgos importantes que cambiaron la comprensión del cliente sobre el mercado peruano:",

    "project.spotify.finding-1-title": "🔍 La hipótesis fue refutada",
    "project.spotify.finding-1-text":
      "Los usuarios NO valoraban más el plan Premium per se. La realidad era más compleja: muchos ya habían tenido contacto previo con Spotify (a través de cuentas familiares, correos antiguos, o períodos de prueba anteriores), lo que los llevaba a suscribirse directamente sin explorar el freemium nuevamente.",

    "project.spotify.finding-2-title": "📱 Contexto cultural y tecnológico",
    "project.spotify.finding-2-text":
      "Identificamos barreras específicas del mercado peruano relacionadas con confianza digital, métodos de pago, terminología traducida y patrones de uso de tecnología que diferían significativamente de mercados desarrollados.",

    "project.spotify.finding-3-title": "🎵 Competencia y alternativas",
    "project.spotify.finding-3-text":
      "Los usuarios peruanos utilizaban múltiples plataformas simultáneamente (YouTube, servicios preinstalados en móviles, etc.), cada una para diferentes necesidades, lo que complejizaba el journey de adopción.",

    "project.spotify.finding-4-title": "💡 Oportunidades identificadas",
    "project.spotify.finding-4-text":
      "Propusimos mejoras específicas en comunicación, onboarding, localización de contenido y estrategias de conversión adaptadas a las realidades del mercado local.",
    ...
    "project.spotify.learning-3-text":
    ...
    "sidebar.interested-text-spotify":
      "Si quieres conocer más sobre mi trabajo en investigación cualitativa y análisis de usuarios, hablemos.",
    ...
    "project.mincetur.hero-subtitle":
      "Taller intensivo de 3 días con líderes de CITE de todo Perú para co-crear un modelo de gestión replicable. Herramientas diseñadas seguían en uso 2 años después.",

    "project.mincetur.context-text-1":
    ...
    "project.mincetur.context-text-2":
    ...
    "project.mincetur.context-text-3":
    ...
    "project.mincetur.challenge-text":
    ...
    "project.tali.hero-subtitle":
      "Proyecto freelance para crear una agencia de viajes completamente digital orientada a corporaciones. Investigación, diseño de experiencia para 4 perfiles de usuario y creación completa de marca desde cero.",

    "project.tali.context-text-1":
    ...
    "project.lumi.hero-subtitle":
      "Plataforma de aprendizaje personalizado que transforma la educación en una experiencia emocionante y llena de propósito, donde cada estudiante descubre su propio camino.",
    ...
    "project.lumi.styles-intro":
      "Lumi reconoce que no todos aprendemos igual. Por eso creamos 5 perfiles únicos que adaptan la experiencia educativa a tu forma natural de procesar información:",
  ...
  en: {
    ...
    "project.agenda.desc":
      "Redesign of the web appointment system for Clínica Alemana during the pandemic. Alignment with the teleconsultation platform and incremental phased deployment.",
    ...
    "project.spotify.desc":
      "Analysis of why users in Peru subscribe to premium service without using freemium. Qualitative research that changed the localization strategy.",
    "project.spotify.metric1": "Users",
    "project.spotify.metric2": "Countries",
    "project.spotify.metric3": "Modality",
    "project.cubico.desc":
      "Collaborative educational program that empowered young people in Seville to design sustainable solutions in their community.",
    ...
    "project.bid.desc":
      "Strategic redesign of internal services at the IDB Secretariat. 80 interviews across 7-10 countries, diagnosis of 50+ systems, and redesign of invisible processes to improve coordination and reduce operational overload.",
    ...
    // 2023
    "journey.timeline.2023.title": "FRUTA - Sustainable Service Designer",
    "journey.timeline.2023.meta": "Feb 2023 - Jul 2023 • Spain",
    "journey.timeline.2023.description":
      "Sustainable design and innovation consultant for corporate social responsibility project. Co-design workshop facilitation with students and teachers.",
    ...
    // 2020
    "journey.timeline.2020.title": "Continuum HQ - Service Designer",
    "journey.timeline.2020.meta": "Jan 2020 - Feb 2022 • Peru/Chile",
    "journey.timeline.2020.description-1": "Led user research to optimize digital products.",
    "journey.timeline.2020.description-2": "Featured projects:",
    "journey.timeline.2020.description-3":
      "Clínica Alemana (Telemedicine + Web Scheduling), BID (Secretariat Redesign), Spotify (Premium Research), UPC.",

    // 2019
    "journey.timeline.2019.title": "Beta User Testing - Service Designer",
    "journey.timeline.2019.meta": "Oct 2019 - Jul 2020 • Peru",
    "journey.timeline.2019.description":
      "Digital product testing and validation consultant. Usability testing, qualitative and quantitative data analysis with actionable insights.",

    // 2018
    "journey.timeline.2018.title": "Ají limo - UX + Social Media Manager",
    "journey.timeline.2018.meta": "Nov 2018 - Nov 2019 • Peru",
    "journey.timeline.2018.description":
      "Digital marketing and UX strategy development. Social media content planning and management. KPI analysis and campaign optimization.",

    // 2017
    "journey.timeline.2017.title": "CreativeLab - Director of Untangling",
    "journey.timeline.2017.meta": "Nov 2017 - Oct 2018 • Peru",
    "journey.timeline.2017.description":
    ...
    "journey.projects.spotify.title": "Spotify - UX Research",
    "journey.projects.spotify.description":
      "Research that changed the localization strategy. I discovered that data without context can lead to wrong decisions.",
    "journey.projects.link": "View full project",
    "journey.projects.btn-all": "View all my projects",
    ...
    "journey.skills.ai-text":
      "I use AI as a daily work tool. Not to replace critical thinking, but to accelerate repetitive tasks and explore solutions faster.",
    "journey.skills.pm": "Agile methodologies, stakeholder management, multidisciplinary team coordination, roadmaps and prioritization.",

    // === LEARNING ===
    "journey.learning.badge": "Education",
    "journey.learning.description": "Certifications and continuous training in design, development, and project management.",
    "journey.learning.in-progress": "In Progress",
    "journey.learning.google.subtitle": "Coursera • 6 courses",
    "journey.learning.progress": "Progress",
    "journey.learning.started": "Started",
    "journey.learning.mouredev.title": "JavaScript from scratch",
    "journey.learning.completed": "Completed Certifications",
    "journey.learning.product-designer": "How to be a Product Designer",
    "journey.learning.psicologia": "Cognitive Psychology and UX",

    // === FILOSOFÍA ===
    "journey.filosofia.title": "How I Work",
    ...
    "journey.filosofia.sistemico-text": "I understand how each piece connects to the whole. I design solutions that work in real context.",
    "journey.filosofia.colaboracion-title": "Collaboration",
    "journey.filosofia.colaboracion-text": "Experience working with multidisciplinary teams: developers, designers, product managers.",
    "journey.filosofia.impacto-title": "Impact Focus",
    "journey.filosofia.impacto-text":
      "I don't design for the sake of designing or code for the sake of coding. I seek to create solutions that provide real value.",
    ...
    // Role
    "project.bid.role-text":
      "As Lead Service Designer at Continuum, I led the research strategy, design process, and coordination of the multidisciplinary team throughout the 6-month project.",
    ...
    "project.bid.finding-2-text":
      "The 50+ tools not only generated technical inefficiency: they generated emotional exhaustion. People spent more time managing systems than doing their actual work.",
    "project.bid.finding-3-title": "Systemic distrust",
    "project.bid.finding-3-text":
      'The lack of traceability and visibility had generated cultures of distrust. Example: maintaining three versions of the same table because "someone always deletes something without warning".',
    "project.bid.finding-4-title": "Each area had invented its own system",
    "project.bid.finding-4-text":
      "In the absence of clear processes, each team had developed their own solutions (Excel, emails, WhatsApp groups, unstructured shared folders). This multiplied complexity.",
    "project.bid.finding-5-title": "High cultural and political sensitivity",
    "project.bid.finding-5-text":
      "Working with representatives from 7-10 countries required navigating cultural differences, formal protocols, and power dynamics with great sensitivity and respect.",
    ...
    "project.bid.reflection-2":
      "Designing in this context taught me to move between deep empathy and strategic clarity. I learned to hold complexity, listen without judgment, and facilitate difficult but necessary conversations.",
    "project.bid.reflection-3":
      "Sometimes, design doesn't start with a brilliant solution, but with the humility to recognize that people's work dignity deserves a system that doesn't wear them down. This project taught me that service design is an act of institutional care.",
    "project.bid.reflection-4":
    ...
    "project.agenda.challenge-text":
      "How to design a new digital medical appointment channel that coherently connected with the teleconsultation service, improving patient experience in a context of high health urgency, coordinating multiple teams and platforms in parallel?",

    "project.agenda.role-text":
      "As UX/Service Designer at Continuum, I worked for 14 months on this project, leading the strategic service design, facilitating workshops, guiding the experience vision, and aligning flows between different systems, teams, and channels.",
    ...
    "project.agenda.reflection-2":
      "Supporting this channel for 14 months allowed me to see how digital experience can transform from the essential, growing with purpose and meaning. Seeing how over 70,000 people could access quality medical care in critical moments, many with little previous technological experience, reaffirmed my conviction about the power of people-centered design.",
    "project.agenda.reflection-3":
      "This project not only transformed Clínica Alemana's service; it also transformed my understanding of service design in complex ecosystems and my ability to maintain human focus even under extreme pressure.",
    ...
    "project.teleconsulta.context-text-1":
      "During 2020, in the midst of the pandemic, we accompanied Clínica Alemana Santiago in designing its own teleconsultation platform. Although development was carried out in parallel with the redesign of its Web Appointment System, both teams worked in a coordinated manner to ensure a smooth and continuous experience for patients and doctors.",
    "project.teleconsulta.context-text-2":
      "This new solution had to respond to specific challenges of the health context, facilitate the digital experience for audiences not yet accustomed to this type of platform, and at the same time, free up the operational burden faced by the medical team.",
    "project.teleconsulta.context-text-3":
      "The project was developed in a complex ecosystem, coordinating with multiple teams and consultancies:",

    "project.teleconsulta.challenge-text":
      "How to design a medical teleconsultation platform from scratch, in the midst of a health emergency, that would allow safe and efficient remote care, without increasing the operational burden on medical personnel?",

    "project.teleconsulta.role-text":
      "I participated as a service designer, ensuring that the care experience was consistent and clear across all touchpoints. I supported the process for 14 months (the team continued after my departure), applying an incremental design approach that allowed us to launch an initial version in 6 months and continue iterating with value improvements for users and teams.",
    ...
    "project.teleconsulta.reflection-2":
      'Seeing how the story resonated in presentations, how teams began referring to "Act 4" or "the Wizard of Oz problem," taught me that service design isn\'t just mapping flows, but creating shared languages that facilitate decision-making.',
    "project.teleconsulta.reflection-3":
      "The depth of research, attention to details, and coordination between multiple teams made possible something that seemed unfeasible in the midst of uncertainty. Supporting this transformation from service design was a lesson in empathy, strategy, and commitment to real value.",
    "project.teleconsulta.reflection-4":
      "This project reaffirmed my conviction: the best solutions are born when we combine methodological rigor with deep human empathy, and when we know how to communicate our findings in a way that inspires action.",
    ...
    "project.cubico.context-text-1":
      "In collaboration with Fruta, a consultancy specialized in design for sustainability, and Cubico Iberia, a leading company in sustainable investments, we developed a pilot corporate social responsibility (CSR) program in Morón de la Frontera, Seville.",
    "project.cubico.context-text-2":
      "The goal was to strengthen the link between education, sustainability, and renewable energy, empowering young people to become agents of change in their communities. This program sought not only to educate about sustainability, but to give students real design tools to identify and solve local problems.",
    "project.cubico.context-text-3":
      "The project was developed in two schools in the area, working with both ESO (Compulsory Secondary Education) and Vocational Training students, each with different needs and contexts.",

    "project.cubico.challenge-text":
      "Design and implement an educational program that integrated innovation, sustainability, and energy, aimed at secondary and vocational training students. The challenge was to create a participatory methodology that would allow young people to identify and solve local social and environmental problems, fostering their commitment to sustainable development.",
    ...
    "project.cubico.methodology-intro":
      'The entire program was a careful adaptation of Design Thinking methodology to the educational context. It wasn\'t simply about "teaching" Design Thinking, but creating an experience where young people lived the complete process:',
    "project.cubico.methodology-empathize-title": "🔍 Empathize",
    "project.cubico.methodology-empathize-text":
      "Initial workshops with the community allowed students to understand real problems in their environment, not abstract or theoretical problems.",
    "project.cubico.methodology-define-title": "🎯 Define",
    "project.cubico.methodology-define-text":
      "With pedagogical tools, teams learned to synthesize information and focus their efforts on specific, actionable problems.",
    "project.cubico.methodology-ideate-title": "💡 Ideate",
    "project.cubico.methodology-ideate-text":
      "The interactive game board facilitated collaborative ideation sessions, fostering creativity without losing focus on sustainability.",
    "project.cubico.methodology-prototype-title": "🛠️ Prototype",
    "project.cubico.methodology-prototype-text":
      "Students developed tangible prototypes of their solutions, learning about iteration and continuous improvement.",
    "project.cubico.methodology-test-title": "🧪 Test",
    "project.cubico.methodology-test-text":
      "Final presentations functioned as validation moments, where they received feedback from teachers, peers, and Cubico representatives.",
    ...
    "project.cubico.reflection-2":
      "Working with teachers was especially enriching: it wasn't just about giving them a pedagogical \"kit,\" but co-creating with them, respecting their knowledge of the educational context and adapting our methodologies to their realities. Seeing how they embraced Design Thinking and made it their own was one of the project's greatest achievements.",
    "project.cubico.reflection-3":
      "Additionally, it strengthened my ability to adapt design methodologies to diverse educational and cultural contexts. I learned that designing for education isn't just creating content, but creating experiences that transform the way young people and teachers relate to problems in their environment.",
    "project.cubico.reflection-4":
    ...
    "project.upc.hero-subtitle":
      "Omnichannel redesign of the admissions experience at UPC, integrating physical spaces and digital platform for prospective students and parents. Project with real testing at locations with ~30 users in high-traffic context.",

    // Context
    "project.upc.context-text-1":
      "The Universidad Peruana de Ciencias Aplicadas (UPC) sought to redesign its care experience for prospective students and parents at its physical locations. Our goal from Continuum was to improve both the process and physical space, proposing omnichannel solutions that aligned digital and in-person experience during the admissions process.",
    "project.upc.context-text-2":
      "The organizational context was complex: At the kick-off, we discovered there were 3 similar projects running in parallel within the university, each working in isolation (in silos) on digitizing enrollment. Our team managed to develop valuable findings and concrete proposals that were differentiated by a comprehensive approach: we not only designed the digital experience, but also the complete redesign of the physical admissions space.",
    "project.upc.context-text-3":
      "Part of our solutions were implemented directly at physical locations, while other inputs were absorbed by a different project that had greater political weight within the institution. Even so, the impact of our proposal was significant and validated with real testing under high-traffic conditions.",

    // Challenge
    "project.upc.challenge-text":
      "Ensure that prospective students and parents have a good experience in the admissions process, leading them to choose and remain at UPC. Focusing on a single channel would make us think of a siloed solution. It is necessary to see the service as one great omnichannel experience.",

    // Role
    "project.upc.role-text":
      "As Service Designer at Continuum, I participated in all stages of the project: from initial research, ideation, prototyping and testing solutions, to final delivery.",
    ...
    "project.upc.process-intro":
      "We implemented a user-centered design process with a focus on omnichannel, ensuring each touchpoint was integrated and supported by the same information base.",
    ...
    "project.upc.finding-3-text":
      "It's important to define which moments should be in-person and which digital: In-person: Take guided tours, take admissions exam. Digital: Schedule tours, schedule and pay for exam, view results.",
    ...
    "project.spotify.hero-subtitle":
      "Qualitative research on Spotify Premium subscription patterns in Peru. Bilingual comparative study that refuted the client's initial hypothesis, revealing insights about user behavior in emerging markets.",

    // Context
    "project.spotify.context-text-1":
      "This project emerged from a partnership between Spotify, a German consultancy, and Ayer Viernes (Chile), who invited us to participate as the research team for the Peruvian market. Spotify had detected an unusual pattern: in countries like Peru, many users subscribed directly to Premium without first using the free plan, contrary to what occurred in other markets.",
    "project.spotify.context-text-2":
      "The global team assumed this was due to a perception of greater value in the paid plan, but there was no qualitative data to support it. It was necessary to investigate whether this hypothesis held in the local context and, if not, understand what was really happening.",
    "project.spotify.context-nda":
      "Note: This project was under NDA (Non-Disclosure Agreement), so the information shared here is limited to methodological aspects, general learnings, and my role in the process, without revealing sensitive or proprietary client data.",
    ...
    "project.spotify.finding-1-text":
      "Users did NOT value the Premium plan more per se. The reality was more complex: many had already had prior contact with Spotify (through family accounts, old emails, or previous trial periods), which led them to subscribe directly without exploring freemium again.",

    "project.spotify.finding-2-title": "📱 Cultural and technological context",
    "project.spotify.finding-2-text":
      "We identified specific barriers in the Peruvian market related to digital trust, payment methods, translated terminology, and technology usage patterns that differed significantly from developed markets.",

    "project.spotify.finding-3-title": "🎵 Competition and alternatives",
    "project.spotify.finding-3-text":
      "Peruvian users used multiple platforms simultaneously (YouTube, pre-installed mobile services, etc.), each for different needs, which complicated the adoption journey.",

    "project.spotify.finding-4-title": "💡 Identified opportunities",
    "project.spotify.finding-4-text":
      "We proposed specific improvements in communication, onboarding, content localization, and conversion strategies adapted to local market realities.",
    ...
    "project.spotify.reflection-2":
      "Working with a global client like Spotify, under NDA, and with the responsibility of translating not just languages but cultural contexts, was a formative challenge that strengthened my skills as a researcher. I learned that good research isn't just about collecting data, but interpreting it with empathy and rigor, communicating it clearly, and above all, having the courage to refute hypotheses when evidence demands it.",
    "project.spotify.reflection-3":
      "This project also showed me the importance of working in multicultural and multilingual teams, where each member contributes unique perspectives that enrich the final analysis.",
    ...
    "project.mincetur.context-text-1":
      "This project was an intensive 3-day workshop requested by the Ministry of Foreign Trade and Tourism (MINCETUR) of Peru, with the objective of accompanying CITE (Centers for Productive Innovation and Technology Transfer) leaders in building a replicable management model aligned with State requirements.",
    "project.mincetur.context-text-2":
    ...
    "project.mincetur.context-text-3":
      "Working from Creative Lab, we created our own tools, adapted existing ones, and facilitated the entire process from start to finish. Through collaborative dynamics, we helped participants interpret data, define goals, and clearly visualize their roadmaps.",
    "project.mincetur.context-note":
      "Personal note: This was one of my first projects as a Service Designer, and it was an invaluable formative experience in intensive facilitation and strategic tool design.",

    "project.mincetur.challenge-text":
      "Design and facilitate an intensive 3-day workshop that would allow CITE leaders from all over Peru to co-create a replicable management model, translating complex State requirements into practical and accessible tools they could implement immediately.",
    ...
    "project.mincetur.process-intro":
      "The project was structured in two phases: an intensive 2-week preparation and a 3-day in-person workshop with all CITE leaders.",
    ...
    "project.mincetur.reflection-2":
      "Being one of my first professional projects, it marked me deeply. I learned that service design isn't just methodology, but also active listening, flexibility, and trust in people's ability to solve their own challenges when given the right tools.",
    "project.mincetur.reflection-3":
    ...
    "project.tali.hero-subtitle":
      "Freelance project to create a fully digital travel agency oriented to corporations. Research, experience design for 4 user profiles, and complete brand creation from scratch.",

    "project.tali.context-text-1":
      "This project was born as a private initiative to create a fully digital travel agency oriented to employees of large corporations. It involved designing a service that would allow planning, visualizing, and managing corporate travel from different devices and roles, without friction.",
    "project.tali.context-text-2":
      "We worked as a 3-person freelance team for 2 months, developing everything from scratch: market research, user definition, experience design, brand creation, naming, and complete value proposition.",
    "project.tali.context-text-3":
      "Although the project wasn't implemented due to funding issues, we delivered a complete package that included qualitative research, insight clustering, differentiated user flow design, brand identity (including the name TALI), and functional landing page. It was a valuable experience due to the complexity of users, use cases, and flows involved.",

    "project.tali.challenge-text":
      "Design from scratch a digital platform that would allow multiple user profiles (travelers, supervisors, HR, support) to manage corporate travel smoothly, considering the complexities of authorizations, expense reports, traceability, and support at each stage of the trip.",

    "project.tali.role-text":
      "I worked as Researcher / Service Designer, working in a freelance team with 2 other designers. I accompanied the project from its zero phase to the delivery of the complete proposal.",
    ...
    "project.tali.finding-1-text":
      "A single corporate trip is perceived and managed completely differently by the traveler, planner, approver, and tracking team. Each role has different needs, frictions, and expectations that must be addressed without creating unnecessary complexity.",

    "project.tali.finding-2-title": "It's easy to fall into infinite flows",
    "project.tali.finding-2-text":
      "If clear limits aren't defined by user and context, flows can become infinitely complex. It was crucial to establish which actions corresponded to each role and at what moment in the journey.",

    "project.tali.finding-3-title": "Needs change at each moment of the trip",
    "project.tali.finding-3-text":
      "Before the trip: planning and approvals. During the trip: support and modifications. After the trip: expense reports and closures. The platform must anticipate these changing moments.",

    "project.tali.finding-4-title": "Digital-physical coherence is fundamental",
    "project.tali.finding-4-text":
      "In corporate environments, coherence between digital (platform) and printed (vouchers, reports) is crucial for the perception of professionalism and service reliability.",

    "project.tali.finding-5-title": "Visibility generates trust",
    "project.tali.finding-5-text":
      "Both travelers and supervisors need complete visibility of trip status in real time. Traceability isn't a \"nice to have,\" it's a fundamental requirement.",
    ...
    "project.tali.reflection-quote":
      "Designing for multiple profiles at once demands clear limits, strategic vision, and great attention to detail.",
    "project.tali.reflection-1":
      "This project helped me better understand the challenges of complex services with multiple simultaneous users, and the importance of making visual even what doesn't yet exist. Working in a small multidisciplinary team was enriching: each contributed their expertise and together we built something coherent.",
    "project.tali.reflection-2":
      "Although the project wasn't implemented, the learning was invaluable. Designing from scratch forces you to question every decision: why this flow and not another? Why this name? What real problem are we solving? Not having legacy system constraints was liberating, but also demanded greater strategic rigor.",
    "project.tali.reflection-3":
